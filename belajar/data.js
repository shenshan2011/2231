...
export const MATERI_CONTENT = {
  ...
  'ipa-13': {
    ...
    sub: 'Rantai makanan dan hubungan antar makhluk hidup',
    body: `
      <div class="content-section">
        <h3>🌿 Apa itu Ekosistem?</h3>
        <p>Ekosistem adalah hubungan timbal balik antara <strong>makhluk hidup (biotik)</strong> dengan <strong>lingkungan tak hidup (abiotik)</strong> di suatu tempat.</p>
        <div class="info-box blue">Contoh ekosistem: hutan, sungai, sawah, laut, padang rumput.</div>
      </div>
      <div class="content-section">
        <h3>🔗 Rantai Makanan</h3>
        <p>Urutan makan-dimakan dari produsen hingga pengurai.</p>
        <div class="flow">
          <div class="flow-box">🌾 Produsen<br><small>Tumbuhan</small></div>
          <div class="flow-arrow">→</div>
          <div class="flow-box">🐛 Konsumen I<br><small>Herbivora</small></div>
          <div class="flow-arrow">→</div>
          <div class="flow-box">🐸 Konsumen II<br><small>Karnivora kecil</small></div>
          <div class="flow-arrow">→</div>
          <div class="flow-box">🦅 Konsumen III<br><small>Karnivora besar</small></div>
          <div class="flow-arrow">→</div>
      ...
      <div class="content-section">
        ...
        <div class="table-wrap"><table>
          ...
          <tr><td><strong>Mutualisme</strong></td><td>Kedua pihak sama-sama <em>untung</em></td><td>Lebah & bunga, kupu-kupu & bunga</td></tr>
          <tr><td><strong>Komensalisme</strong></td><td>Satu untung, satu <em>tidak rugi maupun untung</em></td><td>Ikan remora & hiu, anggrek & pohon</td></tr>
          <tr><td><strong>Parasitisme</strong></td><td>Satu untung, satu <em>dirugikan</em></td><td>Kutu & manusia, benalu & pohon</td></tr>
        </table></div>
        <div class="info-box green">Predasi ≠ simbiosis. Predasi adalah hubungan pemangsa dan mangsa (harimau memangsa rusa).</div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan komponen biotik dan abiotik?', a:'Biotik = makhluk hidup (hewan, tumbuhan, jamur). Abiotik = benda tak hidup (air, udara, tanah, cahaya).' },
      { q:'Apa itu rantai makanan?', a:'Urutan hubungan makan-dimakan: produsen → konsumen I → konsumen II → pengurai.' },
      { q:'Apa itu simbiosis mutualisme?', a:'Hubungan dua makhluk hidup yang saling menguntungkan. Contoh: lebah mendapat nektar, bunga terbantu penyerbukan.' },
      { q:'Apa itu simbiosis parasitisme?', a:'Hubungan di mana satu pihak untung dan pihak lain dirugikan. Contoh: kutu di rambut manusia.' },
      { q:'Apa peran pengurai dalam ekosistem?', a:'Mengurai sisa organisme mati menjadi zat anorganik yang bisa diserap tumbuhan kembali.' },
    ],
  },

  'ipa-14': {
    title: '🌿 Fotosintesis',
    sub: 'Proses pembuatan makanan oleh tumbuhan',
    body: `
      <div class="content-section">
        <h3>🌞 Apa itu Fotosintesis?</h3>
        <p>Fotosintesis adalah proses tumbuhan membuat makanan sendiri menggunakan <strong>cahaya matahari</strong>.</p>
        <div class="flow">
          <div class="flow-box">💧 Air (H₂O)<br><small>dari akar</small></div>
          <div class="flow-arrow">+</div>
          <div class="flow-box">💨 CO₂<br><small>dari udara</small></div>
          <div class="flow-arrow">+</div>
          <div class="flow-box">☀️ Cahaya<br><small>matahari</small></div>
          <div class="flow-arrow">→</div>
          <div class="flow-box">🍬 Glukosa<br><small>makanan</small></div>
          <div class="flow-arrow">+</div>
          <div class="flow-box">🌬️ O₂<br><small>dilepas</small></div>
        </div>
        <div class="info-box green">Rumus: 6CO₂ + 6H₂O + cahaya → C₆H₁₂O₆ (glukosa) + 6O₂</div>
      </div>
      <div class="content-section">
        <h3>🍃 Tempat & Syarat Fotosintesis</h3>
        <div class="table-wrap"><table>
          <tr><th>Aspek</th><th>Keterangan</th></tr>
          <tr><td>Tempat</td><td>Kloroplas (mengandung klorofil/zat hijau daun)</td></tr>
          <tr><td>Bahan baku</td><td>Air (H₂O) + Karbon dioksida (CO₂)</td></tr>
          <tr><td>Sumber energi</td><td>Cahaya matahari</td></tr>
          <tr><td>Hasil</td><td>Glukosa (makanan) + Oksigen (O₂)</td></tr>
        </table></div>
        <div class="info-box blue">Oksigen yang dihasilkan fotosintesis adalah sumber O₂ yang kita hirup!</div>
      </div>
      <div class="content-section">
        <h3>🔬 Faktor yang Mempengaruhi</h3>
        <p>Intensitas cahaya, ketersediaan air, kadar CO₂, dan suhu lingkungan mempengaruhi kecepatan fotosintesis.</p>
      </div>`,
    flashcards: [
      { q:'Apa bahan baku fotosintesis?', a:'Air (H₂O) yang diserap akar dan karbon dioksida (CO₂) yang diserap dari udara melalui stomata.' },
      { q:'Di bagian mana tumbuhan melakukan fotosintesis?', a:'Di kloroplas, sel yang mengandung klorofil (zat hijau daun), terutama di daun.' },
      { q:'Apa hasil dari fotosintesis?', a:'Glukosa (makanan untuk tumbuhan) dan oksigen (O₂) yang dilepas ke udara.' },
      { q:'Mengapa daun berwarna hijau?', a:'Karena mengandung klorofil, pigmen hijau yang menyerap cahaya matahari untuk fotosintesis.' },
      { q:'Apa hubungan fotosintesis dengan kehidupan manusia?', a:'Fotosintesis menghasilkan O₂ yang kita hirup dan menjadi dasar rantai makanan di bumi.' },
    ],
  },

  'ipa-15': {
    title: '💪 Gaya',
    sub: 'Gravitasi, gesek, pegas, dan otot',
    body: `
      <div class="content-section">
        <h3>⚡ Apa itu Gaya?</h3>
        <p>Gaya adalah <strong>tarikan atau dorongan</strong> yang dapat mengubah bentuk, posisi, atau kecepatan suatu benda. Satuan gaya: <strong>Newton (N)</strong>.</p>
        <div class="info-box blue">Gaya dapat membuat benda diam menjadi bergerak, benda bergerak menjadi diam, atau mengubah arah gerak benda.</div>
      </div>
      <div class="content-section">
        <h3>🔍 Jenis-Jenis Gaya</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis Gaya</th><th>Pengertian</th><th>Contoh</th></tr>
          <tr><td><strong>Gaya Gravitasi</strong></td><td>Gaya tarik bumi terhadap semua benda</td><td>Buah jatuh ke bawah, bola dilempar kembali turun</td></tr>
          <tr><td><strong>Gaya Gesek</strong></td><td>Gaya yang timbul akibat dua permukaan bersentuhan</td><td>Rem sepeda, telapak kaki saat berjalan</td></tr>
          <tr><td><strong>Gaya Pegas</strong></td><td>Gaya oleh benda elastis yang ditekan/ditarik</td><td>Pegas kasur, ketapel, busur panah</td></tr>
          <tr><td><strong>Gaya Otot</strong></td><td>Gaya yang dihasilkan oleh otot makhluk hidup</td><td>Mendorong meja, mengangkat tas</td></tr>
          <tr><td><strong>Gaya Magnet</strong></td><td>Gaya tarik/tolak dari magnet</td><td>Magnet menarik besi, kompas</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        ...
        <div class="table-wrap"><table>
          ...
          <tr><td>Rem kendaraan bisa bekerja</td><td>Mesin cepat aus</td></tr>
          <tr><td>Kita bisa berjalan tanpa terpeleset</td><td>Ban sepeda cepat habis</td></tr>
        </table></div>
        <div class="info-box green">Gaya gesek diperkecil dengan melumasi mesin (oli). Gaya gesek diperbesar dengan membuat permukaan kasar (tapak ban).</div>
      </div>`,
    flashcards: [
      { q:'Apa itu gaya?', a:'Tarikan atau dorongan yang dapat mengubah bentuk, posisi, atau kecepatan benda. Satuan: Newton (N).' },
      { q:'Apa itu gaya gravitasi?', a:'Gaya tarik bumi terhadap semua benda sehingga benda selalu jatuh ke bawah.' },
      { q:'Apa itu gaya gesek?', a:'Gaya yang timbul saat dua permukaan bersentuhan dan bergerak saling berlawanan arah.' },
      { q:'Sebutkan 3 pengaruh gaya terhadap benda!', a:'1. Benda diam jadi bergerak. 2. Benda bergerak jadi diam. 3. Mengubah bentuk atau arah gerak benda.' },
      { q:'Bagaimana cara memperkecil gaya gesek pada mesin?', a:'Dengan melumasi permukaan menggunakan oli atau minyak pelumas.' },
    ],
  },

  'ipa-16': {
    title: '🧲 Magnet & Kemagnetan',
    sub: 'Kutub, medan magnet, dan elektromagnet',
    body: `
      <div class="content-section">
        ...
        <div class="info-box blue">Magnet dapat menarik benda dari bahan besi, nikel, dan kobalt (feromagnetik).</div>
      </div>
      <div class="content-section">
        <h3>📦 Jenis Magnet</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Keterangan</th><th>Contoh</th></tr>
          <tr><td><strong>Magnet Alam</strong></td><td>Terbentuk secara alami di alam</td><td>Batu magnetit</td></tr>
          <tr><td><strong>Magnet Buatan</strong></td><td>Dibuat oleh manusia</td><td>Magnet batang, magnet U, magnet jarum</td></tr>
          <tr><td><strong>Elektromagnet</strong></td><td>Magnet dari arus listrik yang mengalir pada kumparan</td><td>Bel listrik, derek besi, MRI</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>⚙️ Cara Membuat Magnet</h3>
        <div class="table-wrap"><table>
          <tr><th>Cara</th><th>Penjelasan</th></tr>
          <tr><td>Gosokan</td><td>Besi digosok magnet searah berulang-ulang</td></tr>
          <tr><td>Induksi</td><td>Besi didekatkan ke magnet (tanpa sentuh)</td></tr>
          <tr><td>Elektromagnet</td><td>Kumparan kawat dialiri arus listrik</td></tr>
        </table></div>
        <div class="info-box green">Keunggulan elektromagnet: kekuatan magnet bisa diatur dan bisa dimatikan dengan memutus arus listrik.</div>
      </div>`,
    flashcards: [
      { q:'Apa yang terjadi jika kutub senama didekatkan?', a:'Tolak-menolak. Kutub U bertemu U, atau S bertemu S, akan saling mendorong.' },
      { q:'Apa itu elektromagnet?', a:'Magnet buatan yang dibuat dengan cara mengalirkan arus listrik melalui kawat yang dililitkan pada inti besi.' },
      { q:'Di mana kekuatan magnet paling besar?', a:'Di kedua ujung/kutub magnet (kutub utara dan kutub selatan).' },
      { q:'Sebutkan 3 cara membuat magnet buatan!', a:'1. Gosokan (digosok searah). 2. Induksi (didekatkan magnet). 3. Elektromagnetik (dialiri arus listrik).' },
      { q:'Benda apa saja yang dapat ditarik magnet?', a:'Benda dari bahan feromagnetik: besi, baja, nikel, dan kobalt.' },
    ],
  },

  'ipa-17': {
    title: '🦎 Adaptasi Hewan',
    sub: 'Nokturnal, ekolokasi, kamuflase, dan hibernasi',
    body: `
      <div class="content-section">
        <h3>🐾 Apa itu Adaptasi?</h3>
        <p>Adaptasi adalah kemampuan makhluk hidup untuk <strong>menyesuaikan diri dengan lingkungannya</strong> agar dapat bertahan hidup.</p>
        <div class="info-box blue">Ada 3 jenis adaptasi: morfologi (bentuk tubuh), fisiologi (fungsi organ), dan tingkah laku.</div>
      </div>
      <div class="content-section">
        <h3>🦇 Jenis-Jenis Adaptasi Hewan</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Pengertian</th><th>Contoh Hewan</th></tr>
          <tr><td><strong>Nokturnal</strong></td><td>Aktif di malam hari, tidur di siang hari</td><td>Kelelawar, burung hantu, musang</td></tr>
          <tr><td><strong>Ekolokasi</strong></td><td>Mendeteksi objek menggunakan gelombang suara pantul</td><td>Kelelawar, lumba-lumba, paus</td></tr>
          <tr><td><strong>Kamuflase</strong></td><td>Menyamarkan diri agar menyerupai lingkungan sekitar</td><td>Bunglon, gurita, ulat daun</td></tr>
          <tr><td><strong>Mimikri</strong></td><td>Meniru penampilan spesies lain yang berbahaya</td><td>Ular raja meniru ular karang</td></tr>
          <tr><td><strong>Hibernasi</strong></td><td>Tidur panjang saat musim dingin untuk hemat energi</td><td>Beruang, kelelawar, ular</td></tr>
          <tr><td><strong>Estivasi</strong></td><td>Tidur panjang saat musim kemarau/panas</td><td>Siput, katak, lungfish</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🦆 Adaptasi Morfologi</h3>
        <div class="table-wrap"><table>
          <tr><th>Hewan</th><th>Adaptasi</th><th>Fungsi</th></tr>
          <tr><td>Bebek</td><td>Kaki berselaput</td><td>Berenang di air</td></tr>
          <tr><td>Kaktus unta (punuk)</td><td>Punuk menyimpan lemak</td><td>Cadangan energi & air di gurun</td></tr>
          <tr><td>Elang</td><td>Paruh dan cakar tajam</td><td>Mencengkeram & merobek mangsa</td></tr>
          <tr><td>Ikan</td><td>Tubuh streamline + sirip</td><td>Berenang cepat di air</td></tr>
        </table></div>
      </div>`,
    flashcards: [
      { q:'Apa itu ekolokasi?', a:'Kemampuan hewan mendeteksi objek di sekitarnya menggunakan pantulan gelombang suara. Dimiliki kelelawar dan lumba-lumba.' },
      { q:'Apa bedanya kamuflase dan mimikri?', a:'Kamuflase = menyamarkan diri menyerupai lingkungan (bunglon). Mimikri = meniru penampilan hewan lain yang berbahaya.' },
      { q:'Apa itu hibernasi?', a:'Tidur panjang hewan selama musim dingin untuk menghemat energi karena makanan langka. Contoh: beruang.' },
      { q:'Sebutkan 3 jenis adaptasi!', a:'1. Morfologi (bentuk tubuh). 2. Fisiologi (fungsi organ dalam). 3. Tingkah laku (cara bertindak).' },
      { q:'Mengapa bebek memiliki kaki berselaput?', a:'Adaptasi morfologi agar mudah berenang dan berjalan di lumpur.' },
    ],
  },

  'ipa-18': {
    title: '🌸 Bagian Tubuh Tumbuhan',
    sub: 'Akar, batang, daun, bunga, dan fungsinya',
    body: `
      <div class="content-section">
        <h3>🌱 Akar</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Ciri</th><th>Contoh</th></tr>
          <tr><td>Akar Serabut</td><td>Banyak akar kecil merata, tidak ada akar utama</td><td>Padi, jagung, rumput (monokotil)</td></tr>
          <tr><td>Akar Tunggang</td><td>Ada satu akar utama besar + akar cabang</td><td>Mangga, wortel, kacang (dikotil)</td></tr>
        </table></div>
        <p><strong>Fungsi akar:</strong> menyerap air & mineral dari tanah, menegakkan tumbuhan, menyimpan cadangan makanan (wortel, singkong).</p>
      </div>
      <div class="content-section">
        <h3>🪵 Batang</h3>
        <p><strong>Fungsi batang:</strong> menopang tumbuhan, menyalurkan air & mineral dari akar ke daun (xilem), menyalurkan hasil fotosintesis dari daun ke seluruh tubuh (floem).</p>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Ciri</th><th>Contoh</th></tr>
          <tr><td>Batang berkayu</td><td>Keras, kuat, berumur panjang</td><td>Pohon mangga, jati, mahoni</td></tr>
          <tr><td>Batang basah</td><td>Lunak, banyak air</td><td>Pisang, bayam, kangkung</td></tr>
          <tr><td>Batang rumput</td><td>Berongga, beruas-ruas</td><td>Padi, bambu, tebu</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🍃 Daun</h3>
        <p><strong>Fungsi daun:</strong> tempat fotosintesis, penguapan air (transpirasi), dan pertukaran gas (melalui stomata).</p>
        <div class="info-box blue">Bagian daun: helai daun (lamina), tangkai daun (petiolus), pelepah daun.</div>
      </div>
      <div class="content-section">
        <h3>🌺 Bunga, Buah & Biji</h3>
        <div class="table-wrap"><table>
          <tr><th>Bagian</th><th>Fungsi</th></tr>
          <tr><td>Bunga</td><td>Alat perkembangbiakan generatif tumbuhan</td></tr>
          <tr><td>Buah</td><td>Pelindung biji, hasil perkembangan bakal buah setelah pembuahan</td></tr>
          <tr><td>Biji</td><td>Calon tumbuhan baru (alat perkembangbiakan)</td></tr>
        </table></div>
        <div class="info-box green">Xilem = pembuluh angkut air (akar → daun). Floem = pembuluh angkut hasil fotosintesis (daun → seluruh tubuh).</div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan akar serabut dan akar tunggang?', a:'Akar serabut: banyak akar kecil merata, tidak ada akar utama (monokotil, misal padi). Akar tunggang: ada satu akar utama besar (dikotil, misal mangga).' },
      { q:'Apa fungsi xilem dan floem?', a:'Xilem mengangkut air dan mineral dari akar ke daun. Floem mengangkut hasil fotosintesis dari daun ke seluruh tubuh tumbuhan.' },
      { q:'Apa fungsi stomata pada daun?', a:'Tempat pertukaran gas (CO₂ masuk, O₂ keluar) dan penguapan air (transpirasi).' },
      { q:'Sebutkan 3 fungsi akar!', a:'1. Menyerap air dan mineral dari tanah. 2. Menopang dan menegakkan tumbuhan. 3. Menyimpan cadangan makanan (pada wortel/singkong).' },
      { q:'Apa fungsi bunga bagi tumbuhan?', a:'Sebagai alat perkembangbiakan generatif — tempat terjadinya penyerbukan dan pembuahan untuk menghasilkan biji.' },
    ],
  },

  'ipa-19': {
    title: '🫁 Sistem Pernapasan & Pencernaan',
    sub: 'Organ dan proses pencernaan manusia',
    body: `
      <div class="content-section">
        <h3>🫁 Sistem Pernapasan</h3>
        <p>Urutan saluran pernapasan manusia:</p>
        <div class="flow">
          <div class="flow-box">👃 Hidung</div><div class="flow-arrow">→</div>
          ...
          <div class="flow-box">Trakea<br><small>batang tenggorokan</small></div><div class="flow-arrow">→</div>
          <div class="flow-box">Bronkus</div><div class="flow-arrow">→</div>
          <div class="flow-box">🫁 Paru-paru<br><small>(alveolus)</small></div>
        </div>
        <div class="info-box blue">Pertukaran O₂ dan CO₂ terjadi di <strong>alveolus</strong> (gelembung paru-paru kecil yang berdinding tipis).</div>
      </div>
      <div class="content-section">
        <h3>🍽️ Sistem Pencernaan</h3>
        <div class="flow">
          <div class="flow-box">👄 Mulut<br><small>gigi, lidah, air liur</small></div><div class="flow-arrow">→</div>
          <div class="flow-box">Kerongkongan<br><small>esofagus</small></div><div class="flow-arrow">→</div>
          <div class="flow-box">🫁 Lambung<br><small>asam lambung</small></div><div class="flow-arrow">→</div>
          <div class="flow-box">Usus Halus<br><small>penyerapan sari makanan</small></div><div class="flow-arrow">→</div>
          <div class="flow-box">Usus Besar<br><small>penyerapan air</small></div><div class="flow-arrow">→</div>
          <div class="flow-box">Anus</div>
        </div>
        <div class="table-wrap"><table>
          <tr><th>Organ</th><th>Fungsi Utama</th></tr>
          <tr><td>Mulut</td><td>Pencernaan mekanik (gigi) & kimiawi (enzim amilase di air liur)</td></tr>
          <tr><td>Lambung</td><td>Mencerna protein dengan asam lambung & enzim pepsin</td></tr>
          <tr><td>Usus Halus</td><td>Menyerap sari makanan (nutrisi) ke dalam darah</td></tr>
          <tr><td>Usus Besar</td><td>Menyerap air, membentuk feses</td></tr>
        </table></div>
      </div>`,
    flashcards: [
      { q:'Di mana pertukaran O₂ dan CO₂ terjadi di paru-paru?', a:'Di alveolus — gelembung udara kecil berdinding tipis yang dikelilingi pembuluh darah kapiler.' },
      { q:'Sebutkan urutan organ pencernaan manusia!', a:'Mulut → Kerongkongan → Lambung → Usus Halus → Usus Besar → Anus.' },
      { q:'Apa fungsi usus halus?', a:'Menyerap sari-sari makanan (nutrisi) hasil pencernaan ke dalam aliran darah.' },
      { q:'Enzim apa yang terdapat di air liur dan apa fungsinya?', a:'Enzim amilase (ptialin), berfungsi memecah amilum (zat tepung) menjadi gula sederhana.' },
      { q:'Apa fungsi usus besar?', a:'Menyerap kembali air dari sisa makanan dan membentuk feses sebelum dikeluarkan.' },
    ],
  },

  'ipa-20': {
    title: '🧊 Perubahan Wujud Zat',
    sub: 'Menguap, membeku, menyublim, dan lainnya',
    body: `
      <div class="content-section">
        <h3>🔄 Enam Perubahan Wujud Zat</h3>
        <div class="table-wrap"><table>
          <tr><th>Nama</th><th>Perubahan</th><th>Contoh</th><th>Proses</th></tr>
          <tr><td><strong>Mencair / Melebur</strong></td><td>Padat → Cair</td><td>Es batu mencair, lilin dipanaskan</td><td>Menyerap kalor</td></tr>
          <tr><td><strong>Membeku</strong></td><td>Cair → Padat</td><td>Air menjadi es, lilin mengeras</td><td>Melepas kalor</td></tr>
          <tr><td><strong>Menguap</strong></td><td>Cair → Gas</td><td>Air dipanaskan, alkohol menguap</td><td>Menyerap kalor</td></tr>
          <tr><td><strong>Mengembun</strong></td><td>Gas → Cair</td><td>Embun di pagi hari, uap air di cermin</td><td>Melepas kalor</td></tr>
          <tr><td><strong>Menyublim</strong></td><td>Padat → Gas</td><td>Kapur barus menguap, dry ice</td><td>Menyerap kalor</td></tr>
          <tr><td><strong>Mengkristal / Deposisi</strong></td><td>Gas → Padat</td><td>Salju terbentuk, bunga es di kulkas</td><td>Melepas kalor</td></tr>
        </table></div>
        <div class="info-box blue">Perubahan yang <strong>menyerap kalor</strong>: mencair, menguap, menyublim. Perubahan yang <strong>melepas kalor</strong>: membeku, mengembun, mengkristal.</div>
      </div>
      <div class="content-section">
        <h3>⚗️ Faktor yang Mempengaruhi Penguapan</h3>
        <p>Penguapan lebih cepat jika: suhu lebih tinggi, permukaan lebih luas, ada angin/aliran udara, dan kelembaban udara rendah.</p>
        <div class="info-box green">Perubahan wujud adalah perubahan <strong>fisika</strong> — zat berubah bentuk tapi sifat kimianya tetap sama.</div>
      </div>`,
    flashcards: [
      { q:'Apa itu menyublim? Sebutkan contohnya!', a:'Perubahan wujud dari padat langsung ke gas tanpa melalui fase cair. Contoh: kapur barus (kamper) dan dry ice (es kering CO₂).' },
      { q:'Perubahan wujud apa saja yang menyerap kalor?', a:'Mencair (padat→cair), menguap (cair→gas), dan menyublim (padat→gas).' },
      { q:'Apa itu mengembun? Sebutkan contohnya!', a:'Perubahan wujud dari gas menjadi cair karena melepas kalor. Contoh: embun di pagi hari, titik air di luar gelas es.' },
      { q:'Mengapa pakaian basah lebih cepat kering saat dijemur di tempat berangin?', a:'Angin mempercepat penguapan air dari permukaan pakaian dengan membawa uap air yang terbentuk menjauh.' },
      { q:'Apa bedanya perubahan fisika dan perubahan kimia?', a:'Perubahan fisika: wujud/bentuk berubah tapi zat tetap sama (es mencair). Perubahan kimia: terbentuk zat baru yang berbeda sifatnya (kertas terbakar).' },
    ],
  },

  'ipa-21': {
    title: '🔊 Bunyi & Cahaya',
    sub: 'Sifat, pemantulan, pembiasan, dan dispersi',
    body: `
      <div class="content-section">
        <h3>🔊 Bunyi</h3>
        <p>Bunyi dihasilkan oleh benda yang <strong>bergetar</strong> dan merambat melalui medium (zat perantara).</p>
        <div class="table-wrap"><table>
          <tr><th>Jenis Bunyi</th><th>Frekuensi</th><th>Dapat Didengar</th></tr>
          <tr><td>Infrasonik</td><td>&lt; 20 Hz</td><td>Tidak (manusia). Bisa: gajah, paus</td></tr>
          <tr><td>Audiosonik</td><td>20 – 20.000 Hz</td><td>Ya (manusia normal)</td></tr>
          <tr><td>Ultrasonik</td><td>&gt; 20.000 Hz</td><td>Tidak (manusia). Bisa: kelelawar, lumba-lumba</td></tr>
        </table></div>
        <div class="info-box blue">Bunyi <strong>tidak dapat</strong> merambat di ruang hampa (vakum). Bunyi paling cepat merambat melalui <strong>zat padat</strong>.</div>
      </div>
      <div class="content-section">
        <h3>💡 Cahaya</h3>
        <p>Cahaya adalah gelombang elektromagnetik yang dapat merambat tanpa medium (termasuk di vakum).</p>
        <div class="table-wrap"><table>
          <tr><th>Sifat Cahaya</th><th>Penjelasan</th><th>Contoh</th></tr>
          <tr><td><strong>Merambat lurus</strong></td><td>Cahaya berjalan lurus jika medium homogen</td><td>Berkas sinar matahari menembus celah</td></tr>
          <tr><td><strong>Pemantulan</strong></td><td>Cahaya memantul saat mengenai permukaan</td><td>Cermin, permukaan air tenang</td></tr>
          <tr><td><strong>Pembiasan</strong></td><td>Cahaya membelok saat melewati medium berbeda</td><td>Pensil terlihat patah di dalam air</td></tr>
          <tr><td><strong>Dispersi</strong></td><td>Cahaya putih terurai menjadi spektrum warna</td><td>Pelangi, prisma</td></tr>
          <tr><td><strong>Dapat diserap</strong></td><td>Benda gelap menyerap cahaya lebih banyak</td><td>Baju hitam lebih panas di bawah matahari</td></tr>
        </table></div>
        <div class="info-box green">Warna pelangi (dispersi): <strong>Me-Ji-Ku-Hi-Bi-Ni-U</strong> — Merah, Jingga, Kuning, Hijau, Biru, Nila, Ungu.</div>
      </div>`,
    flashcards: [
      { q:'Mengapa bunyi tidak bisa terdengar di ruang angkasa?', a:'Karena bunyi membutuhkan medium (zat perantara) untuk merambat, sedangkan ruang angkasa adalah vakum (hampa udara).' },
      { q:'Apa itu pembiasan cahaya? Sebutkan contohnya!', a:'Pembelokan cahaya saat berpindah dari satu medium ke medium lain yang berbeda kerapatannya. Contoh: pensil terlihat patah di dalam gelas berisi air.' },
      { q:'Apa itu dispersi cahaya?', a:'Penguraian cahaya putih menjadi spektrum warna-warni saat melewati prisma atau tetesan air. Menghasilkan warna pelangi: Me-Ji-Ku-Hi-Bi-Ni-U.' },
      { q:'Berapa rentang frekuensi bunyi yang dapat didengar manusia?', a:'20 Hz sampai 20.000 Hz (audiosonik). Di bawah 20 Hz = infrasonik, di atas 20.000 Hz = ultrasonik.' },
      { q:'Melalui medium apa bunyi merambat paling cepat?', a:'Zat padat. Urutan: padat > cair > gas. Bunyi merambat paling lambat melalui gas (udara).' },
    ],
  },

  'ipa-22': {
    title: '🪨 Benda & Sifatnya',
    sub: 'Padat, cair, gas, dan perubahan fisika/kimia',
    body: `
      <div class="content-section">
        <h3>📦 Tiga Wujud Benda</h3>
        <div class="table-wrap"><table>
          <tr><th>Wujud</th><th>Bentuk</th><th>Volume</th><th>Jarak antar partikel</th><th>Contoh</th></tr>
          <tr><td><strong>Padat</strong></td><td>Tetap</td><td>Tetap</td><td>Sangat rapat</td><td>Batu, kayu, es</td></tr>
          <tr><td><strong>Cair</strong></td><td>Mengikuti wadah</td><td>Tetap</td><td>Renggang</td><td>Air, minyak, susu</td></tr>
          <tr><td><strong>Gas</strong></td><td>Mengikuti wadah</td><td>Mengikuti wadah</td><td>Sangat renggang</td><td>Udara, uap air, oksigen</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>⚗️ Perubahan Fisika vs Kimia</h3>
        <div class="table-wrap"><table>
          <tr><th>Perubahan Fisika</th><th>Perubahan Kimia</th></tr>
          <tr><td>Tidak menghasilkan zat baru</td><td>Menghasilkan zat baru yang berbeda</td></tr>
          <tr><td>Dapat dikembalikan ke wujud semula</td><td>Umumnya tidak dapat dikembalikan</td></tr>
          <tr><td>Contoh: es mencair, kayu dipotong, gula larut</td><td>Contoh: kayu terbakar, besi berkarat, makanan membusuk</td></tr>
        </table></div>
        <div class="info-box blue">Ciri perubahan kimia: perubahan warna, timbul gas, timbul endapan, perubahan suhu, timbul bau baru.</div>
      </div>
      <div class="content-section">
        <h3>🧪 Sifat Benda</h3>
        <div class="table-wrap"><table>
          <tr><th>Sifat Fisika</th><th>Sifat Kimia</th></tr>
          <tr><td>Warna, bau, kekerasan, titik lebur, daya hantar listrik</td><td>Mudah terbakar, mudah berkarat, kemampuan bereaksi dengan zat lain</td></tr>
        </table></div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan benda padat, cair, dan gas dari segi bentuk dan volumenya?', a:'Padat: bentuk & volume tetap. Cair: bentuk mengikuti wadah, volume tetap. Gas: bentuk & volume mengikuti wadah.' },
      { q:'Apa itu perubahan kimia? Sebutkan 3 cirinya!', a:'Perubahan yang menghasilkan zat baru. Ciri: perubahan warna, timbul gas/bau baru, timbul endapan, perubahan suhu.' },
      { q:'Apakah gula yang larut dalam air termasuk perubahan fisika atau kimia?', a:'Perubahan fisika — gula hanya berubah bentuk (larut), tidak menghasilkan zat baru, dan bisa dipisahkan kembali dengan penguapan.' },
      { q:'Sebutkan contoh perubahan kimia dalam kehidupan sehari-hari!', a:'Besi berkarat, kayu terbakar menjadi abu, makanan membusuk, roti mengembang saat dipanggang.' },
      { q:'Mengapa partikel gas lebih renggang dari partikel padat?', a:'Gaya tarik antar partikel gas sangat lemah sehingga partikel bebas bergerak dan mengisi seluruh ruang wadahnya.' },
    ],
  },

  'ipa-23': {
    title: '🌳 Sumber Daya Alam',
    sub: 'Terbarukan, tidak terbarukan, dan pelestarian',
    body: `
      <div class="content-section">
        <h3>🌍 Apa itu Sumber Daya Alam (SDA)?</h3>
        <p>SDA adalah segala sesuatu yang berasal dari alam dan dapat dimanfaatkan untuk memenuhi kebutuhan manusia.</p>
      </div>
      <div class="content-section">
        <h3>♻️ Jenis SDA</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Pengertian</th><th>Contoh</th></tr>
          <tr><td><strong>SDA Terbarukan</strong></td><td>Dapat dipulihkan secara alami dan tidak akan habis jika dikelola baik</td><td>Air, udara, tanah, hutan, hewan, tumbuhan, energi matahari/angin</td></tr>
          <tr><td><strong>SDA Tidak Terbarukan</strong></td><td>Terbentuk jutaan tahun, tidak bisa dipulihkan dalam waktu singkat</td><td>Minyak bumi, batu bara, gas alam, emas, besi, tembaga</td></tr>
        </table></div>
        <div class="info-box blue">Meski disebut terbarukan, SDA seperti hutan dan air bisa habis jika dieksploitasi berlebihan tanpa pelestarian!</div>
      </div>
      <div class="content-section">
        <h3>🛡️ Upaya Pelestarian SDA</h3>
        <div class="table-wrap"><table>
          <tr><th>Upaya</th><th>Penjelasan</th></tr>
          <tr><td>Reboisasi</td><td>Penanaman kembali hutan yang gundul</td></tr>
          <tr><td>Tebang pilih</td><td>Menebang pohon besar saja, yang kecil dibiarkan tumbuh</td></tr>
          <tr><td>Daur ulang (3R)</td><td>Reduce (kurangi), Reuse (pakai ulang), Recycle (daur ulang)</td></tr>
          <tr><td>Energi alternatif</td><td>Beralih ke energi surya, angin, air agar tidak bergantung BBM</td></tr>
          <tr><td>Cagar alam / suaka margasatwa</td><td>Melindungi flora & fauna langka dari kepunahan</td></tr>
        </table></div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan SDA terbarukan dan tidak terbarukan?', a:'Terbarukan: dapat dipulihkan alami, tidak habis jika dikelola baik (air, hutan). Tidak terbarukan: terbentuk jutaan tahun, bisa habis (minyak bumi, batu bara).' },
      { q:'Apa itu reboisasi?', a:'Upaya penanaman kembali pohon-pohon di hutan yang telah gundul akibat penebangan atau kebakaran.' },
      { q:'Jelaskan konsep 3R dalam pelestarian SDA!', a:'Reduce = mengurangi penggunaan. Reuse = memakai ulang barang. Recycle = mendaur ulang sampah menjadi produk baru.' },
      { q:'Mengapa minyak bumi disebut SDA tidak terbarukan?', a:'Karena terbentuk dari sisa organisme yang membutuhkan jutaan tahun, sehingga tidak bisa dipulihkan dalam waktu manusia.' },
      { q:'Sebutkan 2 contoh energi alternatif terbarukan!', a:'Energi surya (panel surya), energi angin (kincir angin), energi air (PLTA), energi panas bumi (geothermal).' },
    ],
  },

  'ipa-24': {
    title: '💪 Otot Manusia',
    sub: 'Jenis otot, fungsi, dan cara kerja',
    body: `
      <div class="content-section">
        <h3>💪 Fungsi Otot</h3>
        <p>Otot adalah alat gerak aktif manusia. Otot berkontraksi (memendek) dan relaksasi (memanjang) untuk menggerakkan tulang.</p>
        <div class="info-box blue">Tulang = alat gerak <strong>pasif</strong>. Otot = alat gerak <strong>aktif</strong> karena otot yang menggerakkan tulang.</div>
      </div>
      <div class="content-section">
        <h3>🔬 Tiga Jenis Otot</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Ciri</th><th>Kerja</th><th>Letak</th><th>Contoh</th></tr>
          <tr><td><strong>Otot Lurik</strong><br>(rangka)</td><td>Berlurik, sel multinukleus</td><td>Sadar (sesuai kemauan)</td><td>Melekat pada tulang</td><td>Otot lengan, kaki, wajah</td></tr>
          <tr><td><strong>Otot Polos</strong></td><td>Tidak berlurik, sel satu nukleus</td><td>Tidak sadar (otonom)</td><td>Dinding organ dalam</td><td>Lambung, usus, pembuluh darah</td></tr>
          <tr><td><strong>Otot Jantung</strong></td><td>Berlurik bercabang</td><td>Tidak sadar, tidak pernah lelah</td><td>Dinding jantung</td><td>Memompa darah ke seluruh tubuh</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>↔️ Cara Kerja Otot: Antagonis & Sinergis</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis Kerja</th><th>Pengertian</th><th>Contoh</th></tr>
          <tr><td><strong>Antagonis</strong></td><td>Dua otot bekerja <em>berlawanan</em></td><td>Bisep & trisep saat menekuk/meluruskan lengan</td></tr>
          <tr><td><strong>Sinergis</strong></td><td>Dua otot bekerja <em>bersama-sama</em> searah</td><td>Otot pronator saat menelungkupkan tangan</td></tr>
        </table></div>
        <div class="info-box green">Saat bisep berkontraksi (memendek) → lengan menekuk. Saat trisep berkontraksi → lengan meluruskan. Keduanya antagonis.</div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan otot lurik dan otot polos?', a:'Otot lurik: berlurik, bekerja sadar, melekat pada tulang (otot lengan). Otot polos: tidak berlurik, bekerja tidak sadar, di dinding organ dalam (lambung, usus).' },
      { q:'Apa keunikan otot jantung dibanding otot lainnya?', a:'Otot jantung berlurik seperti otot lurik, tapi bekerja tidak sadar seperti otot polos, dan tidak pernah lelah sepanjang hidup.' },
      { q:'Apa itu gerak antagonis otot?', a:'Kerja dua otot yang berlawanan. Saat satu berkontraksi, yang lain relaksasi. Contoh: bisep dan trisep pada lengan atas.' },
      { q:'Mengapa otot disebut alat gerak aktif?', a:'Karena otot yang menghasilkan gaya (berkontraksi dan relaksasi) untuk menggerakkan tulang yang merupakan alat gerak pasif.' },
      { q:'Apa yang terjadi pada bisep saat kita menekuk lengan?', a:'Bisep berkontraksi (memendek/mengeras) sehingga menarik tulang lengan bawah ke atas. Bersamaan itu, trisep berelaksasi (memanjang).' },
    ],
  },

  'ipa-25': {
    title: '🪐 Sistem Tata Surya',
    sub: 'Planet, matahari, rotasi, dan revolusi',
    body: `
      <div class="content-section">
        <h3>☀️ Matahari — Pusat Tata Surya</h3>
        <p>Matahari adalah <strong>bintang</strong> (memancarkan cahaya sendiri) yang menjadi pusat tata surya. Semua planet berevolusi mengelilingi matahari.</p>
        <div class="info-box blue">Cahaya matahari membutuhkan sekitar <strong>8 menit</strong> untuk sampai ke bumi.</div>
      </div>
      <div class="content-section">
        <h3>🪐 Urutan 8 Planet</h3>
        <div class="flow" style="flex-wrap:wrap;gap:6px">
          <div class="flow-box">☀️ Matahari</div><div class="flow-arrow">→</div>
          <div class="flow-box">1. Merkurius</div><div class="flow-arrow">→</div>
          <div class="flow-box">2. Venus</div><div class="flow-arrow">→</div>
          <div class="flow-box">3. Bumi 🌍</div><div class="flow-arrow">→</div>
          <div class="flow-box">4. Mars</div><div class="flow-arrow">→</div>
          <div class="flow-box">5. Jupiter</div><div class="flow-arrow">→</div>
          <div class="flow-box">6. Saturnus</div><div class="flow-arrow">→</div>
          <div class="flow-box">7. Uranus</div><div class="flow-arrow">→</div>
          <div class="flow-box">8. Neptunus</div>
        </div>
        <p style="margin-top:8px">Hafalan: <strong>"My Very Energetic Mother Just Served Us Noodles"</strong></p>
        <div class="table-wrap"><table>
          <tr><th>Planet</th><th>Keistimewaan</th></tr>
          <tr><td>Merkurius</td><td>Terkecil, terdekat matahari, tidak punya satelit</td></tr>
          <tr><td>Venus</td><td>Terpanas (efek rumah kaca), paling terang di langit malam</td></tr>
          <tr><td>Bumi</td><td>Satu-satunya planet berpenghuni, punya 1 satelit (Bulan)</td></tr>
          <tr><td>Mars</td><td>Planet merah, punya 2 satelit (Phobos & Deimos)</td></tr>
          <tr><td>Jupiter</td><td>Terbesar, punya badai besar (Great Red Spot)</td></tr>
          <tr><td>Saturnus</td><td>Punya cincin es yang indah</td></tr>
          <tr><td>Uranus</td><td>Berotasi miring (sumbu hampir horisontal)</td></tr>
          <tr><td>Neptunus</td><td>Terjauh, angin paling kencang di tata surya</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🔄 Rotasi & Revolusi Planet</h3>
        <div class="table-wrap"><table>
          <tr><th></th><th>Rotasi</th><th>Revolusi</th></tr>
          <tr><td>Pengertian</td><td>Berputar pada porosnya sendiri</td><td>Mengelilingi matahari</td></tr>
          <tr><td>Bumi</td><td>24 jam → siang & malam</td><td>365,25 hari → 1 tahun</td></tr>
        </table></div>
        <div class="info-box green">Selain planet, tata surya juga mengandung: asteroid (sabuk asteroid antara Mars–Jupiter), komet (ekor debu & gas), dan meteoroid.</div>
      </div>`,
    flashcards: [
      { q:'Sebutkan urutan 8 planet dari yang terdekat matahari!', a:'Merkurius, Venus, Bumi, Mars, Jupiter, Saturnus, Uranus, Neptunus. (My Very Energetic Mother Just Served Us Noodles)' },
      { q:'Apa perbedaan rotasi dan revolusi bumi?', a:'Rotasi: bumi berputar pada porosnya sendiri (24 jam) → menyebabkan siang dan malam. Revolusi: bumi mengelilingi matahari (365,25 hari) → menyebabkan pergantian tahun dan musim.' },
      { q:'Planet mana yang terbesar dan terkecil di tata surya?', a:'Terbesar: Jupiter. Terkecil: Merkurius.' },
      { q:'Mengapa Venus lebih panas dari Merkurius padahal Merkurius lebih dekat ke matahari?', a:'Karena Venus memiliki atmosfer tebal yang memerangkap panas (efek rumah kaca ekstrem), sedangkan Merkurius hampir tidak punya atmosfer.' },
      { q:'Apa itu komet?', a:'Benda langit yang tersusun dari es, debu, dan gas yang bergerak mengelilingi matahari dengan orbit lonjong. Saat mendekati matahari, es menguap membentuk ekor yang panjang.' },
    ],
  },
