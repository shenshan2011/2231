...
export const MATERI_CONTENT = {
  ...
  'bindo-1': {
    title: '🌿 Peribahasa',
    sub: 'Makna, jenis, dan contoh peribahasa Indonesia',
    body: `
      <div class="content-section">
        <h3>📌 Apa itu Peribahasa?</h3>
        <p><strong>Peribahasa</strong> adalah kalimat atau kelompok kata yang susunannya tetap, mengandung pengertian kiasan, dan menjadi nasihat/sindiran dalam budaya Indonesia. Maknanya tidak bisa diartikan secara harfiah — harus dipahami secara mendalam.</p>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Pengertian</th><th>Contoh</th></tr>
          <tr><td><strong>Peribahasa (umum)</strong></td><td>Kalimat bijak dengan makna kiasan mengandung nasihat atau pengalaman hidup</td><td>"Rajin pangkal pandai"</td></tr>
          <tr><td><strong>Ungkapan</strong></td><td>Gabungan kata dengan makna baru berbeda dari kata aslinya</td><td>"Panjang tangan" = suka mencuri</td></tr>
          <tr><td><strong>Perumpamaan</strong></td><td>Perbandingan menggunakan kata "seperti", "bagai", "laksana"</td><td>"Bagai air di daun talas"</td></tr>
          <tr><td><strong>Pepatah</strong></td><td>Nasihat turun-temurun dari leluhur</td><td>"Berakit-rakit ke hulu"</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>📜 Peribahasa Populer & Maknanya</h3>
        <div class="table-wrap"><table>
          <tr><th>Peribahasa</th><th>Makna</th><th>Digunakan Saat</th></tr>
          <tr><td>Ada gula ada semut</td><td>Di mana ada keuntungan/kesenangan, di situ banyak orang berkumpul</td><td>Menggambarkan orang yang datang karena ada keuntungan</td></tr>
          <tr><td>Air beriak tanda tak dalam</td><td>Orang yang banyak bicara biasanya pengetahuannya dangkal</td><td>Menyindir orang yang banyak omong tapi tidak berisi</td></tr>
          <tr><td>Bagai air di daun talas</td><td>Tidak berpendirian tetap, mudah terpengaruh</td><td>Menggambarkan orang yang tidak konsisten</td></tr>
          <tr><td>Buah jatuh tak jauh dari pohonnya</td><td>Sifat/perilaku anak biasanya mirip orang tuanya</td><td>Saat anak berperilaku seperti orang tuanya</td></tr>
          <tr><td>Nasi sudah menjadi bubur</td><td>Sesuatu yang sudah terjadi tidak bisa diubah lagi</td><td>Menyikapi kesalahan yang sudah terlanjur</td></tr>
          <tr><td>Seperti katak dalam tempurung</td><td>Orang yang berwawasan sempit karena tidak mau tahu hal baru</td><td>Menyindir orang yang tidak mau berkembang</td></tr>
          <tr><td>Setali tiga uang</td><td>Sama saja, tidak ada bedanya</td><td>Membandingkan dua hal yang serupa buruknya</td></tr>
          <tr><td>Pucuk dicinta ulam tiba</td><td>Mendapatkan apa yang diinginkan secara kebetulan</td><td>Saat sesuatu yang diharapkan datang tanpa diduga</td></tr>
          <tr><td>Bersatu kita teguh, bercerai kita runtuh</td><td>Kekuatan ada dalam persatuan</td><td>Menggugah semangat kerjasama</td></tr>
          <tr><td>Sambil menyelam minum air</td><td>Mengerjakan dua hal sekaligus dalam satu waktu</td><td>Menggambarkan efisiensi</td></tr>
          <tr><td>Sedikit demi sedikit, lama-lama menjadi bukit</td><td>Sesuatu yang dilakukan terus-menerus akan menghasilkan sesuatu yang besar</td><td>Memotivasi kesabaran dan ketekunan</td></tr>
          <tr><td>Tak ada gading yang tak retak</td><td>Tidak ada manusia yang sempurna</td><td>Menghibur atau memaklumi kesalahan orang lain</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>✍️ Tips Mengerjakan Soal Peribahasa</h3>
        <ul>
          <li>Baca konteks kalimat di sekitar peribahasa — jangan terpaku pada kata harfiahnya</li>
          <li>Cari kata kunci dalam peribahasa yang bisa menuntun ke maknanya</li>
          <li>Jika soal meminta "peribahasa yang tepat untuk situasi X", cocokkan makna dengan situasinya</li>
        </ul>
        <div class="info-box green">Peribahasa Indonesia banyak mengambil gambaran dari alam: air, pohon, binatang, dan kehidupan pertanian — karena nenek moyang kita dekat dengan alam.</div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan peribahasa, ungkapan, dan perumpamaan?', a:'Peribahasa: kalimat bijak makna kiasan. Ungkapan: gabungan kata bermakna baru (panjang tangan = suka mencuri). Perumpamaan: perbandingan pakai kata "seperti/bagai" (bagai air di daun talas).' },
      { q:'"Ada gula ada semut" maknanya?', a:'Di mana ada keuntungan atau kesenangan, di situ banyak orang berkumpul. Menggambarkan orang yang datang hanya karena ada manfaatnya.' },
      { q:'"Air beriak tanda tak dalam" maknanya?', a:'Orang yang banyak bicara biasanya pengetahuannya dangkal. Orang yang benar-benar pandai biasanya justru pendiam.' },
      { q:'"Seperti katak dalam tempurung" maknanya?', a:'Orang yang berwawasan sempit karena tidak mau tahu dunia luar. Seperti katak yang hidupnya hanya di dalam tempurung yang sempit.' },
      { q:'"Tak ada gading yang tak retak" maknanya?', a:'Tidak ada manusia yang sempurna — semua orang pasti memiliki kekurangan.' },
      { q:'"Sedikit demi sedikit lama-lama menjadi bukit" maknanya?', a:'Sesuatu yang dikerjakan terus-menerus dengan sabar, walaupun kecil, lama kelamaan akan menghasilkan sesuatu yang besar.' },
    ],
  },

  'bindo-2': {
    title: '📊 Bagan',
    sub: 'Jenis bagan, cara membaca, dan cara membuat bagan',
    body: `
      <div class="content-section">
        <h3>📌 Apa itu Bagan?</h3>
        <p><strong>Bagan</strong> adalah representasi visual dari informasi, data, hubungan, atau proses menggunakan simbol, gambar, garis, panah, dan teks. Bagan membantu kita memahami informasi yang kompleks dengan lebih cepat dan mudah.</p>
        <div class="info-box blue">Bagan sering digunakan dalam buku pelajaran, laporan, dan presentasi karena lebih mudah dipahami dibanding teks panjang.</div>
      </div>
      <div class="content-section">
        <h3>📊 Jenis-Jenis Bagan dan Fungsinya</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis Bagan</th><th>Fungsi</th><th>Ciri Khas</th><th>Contoh Penggunaan</th></tr>
          <tr><td><strong>Bagan Alir (Flowchart)</strong></td><td>Menunjukkan urutan langkah atau proses</td><td>Ada kotak dan panah yang mengikuti alur tertentu</td><td>Proses daur ulang, tahapan memasak, alur pengambilan keputusan</td></tr>
          <tr><td><strong>Bagan Organisasi</strong></td><td>Menunjukkan struktur dan hierarki dalam organisasi</td><td>Kotak-kotak bertingkat dari atas ke bawah</td><td>Struktur OSIS, susunan pemerintahan desa, organisasi perusahaan</td></tr>
          <tr><td><strong>Bagan Pohon</strong></td><td>Menunjukkan cabang-cabang klasifikasi dari satu induk</td><td>Seperti pohon bercabang-cabang</td><td>Silsilah keluarga, klasifikasi makhluk hidup, cabang ilmu pengetahuan</td></tr>
          <tr><td><strong>Bagan Lingkaran / Siklus</strong></td><td>Menunjukkan proses yang berulang dan tidak berakhir</td><td>Panah melingkar tanpa titik akhir</td><td>Siklus air, daur hidup kupu-kupu, siklus musim</td></tr>
          <tr><td><strong>Bagan Garis Waktu (Timeline)</strong></td><td>Menunjukkan urutan kejadian berdasarkan waktu</td><td>Garis lurus dengan titik-titik kejadian</td><td>Sejarah kemerdekaan Indonesia, perkembangan teknologi</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🔍 Cara Membaca Bagan dengan Benar</h3>
        <ol>
          <li><strong>Baca judul bagan</strong> — untuk memahami topik yang dibahas</li>
          <li><strong>Perhatikan simbol dan legenda</strong> — kotak, panah, warna biasanya punya arti berbeda</li>
          <li><strong>Ikuti arah panah atau urutan</strong> — biasanya dari atas ke bawah atau kiri ke kanan</li>
          <li><strong>Cari hubungan antar elemen</strong> — apa yang dihubungkan oleh garis/panah</li>
          <li><strong>Buat kesimpulan</strong> — informasi apa yang ingin disampaikan bagan ini</li>
        </ol>
      </div>
      <div class="content-section">
        <h3>✏️ Cara Membuat Bagan yang Baik</h3>
        <div class="table-wrap"><table>
          <tr><th>Langkah</th><th>Yang Dilakukan</th></tr>
          <tr><td>1. Tentukan tujuan</td><td>Ingin menampilkan proses, struktur, siklus, atau perbandingan?</td></tr>
          <tr><td>2. Pilih jenis bagan</td><td>Sesuaikan dengan tujuan (proses → flowchart, struktur → bagan organisasi)</td></tr>
          <tr><td>3. Kumpulkan data/informasi</td><td>Pastikan informasi yang masuk akurat dan lengkap</td></tr>
          <tr><td>4. Susun elemen</td><td>Tempatkan elemen dari yang umum ke khusus atau dari awal ke akhir proses</td></tr>
          <tr><td>5. Tambahkan panah/garis</td><td>Hubungkan antar elemen sesuai alur atau hierarki</td></tr>
          <tr><td>6. Beri judul dan keterangan</td><td>Pastikan pembaca bisa memahami bagan tanpa penjelasan lisan</td></tr>
        </table></div>
        <div class="info-box green">Bagan yang baik: sederhana, jelas, tidak terlalu banyak teks, dan mudah diikuti alurnya oleh siapapun yang membacanya.</div>
      </div>`,
    flashcards: [
      { q:'Sebutkan 4 jenis bagan dan fungsinya!', a:'Bagan alir (urutan proses), bagan organisasi (struktur hierarki), bagan pohon (klasifikasi bercabang), bagan lingkaran/siklus (proses berulang).' },
      { q:'Apa itu flowchart? Kapan digunakan?', a:'Bagan alir yang menunjukkan urutan langkah-langkah dalam suatu proses menggunakan kotak dan panah. Digunakan untuk proses daur ulang, algoritma, atau prosedur kerja.' },
      { q:'Bagan apa yang tepat untuk menampilkan struktur OSIS?', a:'Bagan organisasi — menampilkan hierarki dari ketua OSIS di atas hingga anggota bidang di bawah.' },
      { q:'Sebutkan 5 langkah membaca bagan!', a:'1. Baca judul. 2. Perhatikan simbol/legenda. 3. Ikuti arah panah. 4. Cari hubungan antar elemen. 5. Buat kesimpulan.' },
      { q:'Bagan lingkaran cocok digunakan untuk menggambarkan apa?', a:'Proses yang berulang dan tidak berakhir, seperti siklus air, daur hidup hewan, atau siklus musim.' },
      { q:'Apa yang membedakan bagan pohon dari bagan alir?', a:'Bagan pohon menampilkan klasifikasi/cabang dari satu induk (seperti silsilah keluarga). Bagan alir menampilkan urutan langkah proses yang bergerak dari awal ke akhir.' },
    ],
  },

  'bindo-3': {
    title: '📖 Unsur Intrinsik',
    sub: 'Elemen pembangun cerita dari dalam beserta contohnya',
    body: `
      <div class="content-section">
        <h3>📌 Unsur Intrinsik vs Ekstrinsik</h3>
        <div class="table-wrap"><table>
          <tr><th>Unsur</th><th>Pengertian</th><th>Contoh</th></tr>
          <tr><td><strong>Intrinsik</strong></td><td>Unsur yang membangun cerita dari dalam</td><td>Tema, tokoh, alur, latar, amanat, dll.</td></tr>
          <tr><td><strong>Ekstrinsik</strong></td><td>Unsur dari luar yang mempengaruhi cerita</td><td>Latar belakang pengarang, kondisi sosial, nilai budaya</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🎭 Tujuh Unsur Intrinsik Cerita</h3>
        <div class="table-wrap"><table>
          <tr><th>Unsur</th><th>Pengertian</th><th>Contoh Konkret</th></tr>
          <tr><td>🎯 <strong>Tema</strong></td><td>Ide atau gagasan pokok yang menjadi dasar cerita</td><td>Persahabatan sejati, perjuangan melawan ketidakadilan, pentingnya kejujuran</td></tr>
          <tr><td>👥 <strong>Tokoh</strong></td><td>Pelaku atau karakter dalam cerita</td><td>Budi (tokoh utama), Bu Guru (tokoh pembantu), Si Licik (antagonis)</td></tr>
          <tr><td>😊 <strong>Penokohan</strong></td><td>Cara pengarang menggambarkan sifat dan watak tokoh</td><td>Langsung: "Rara adalah anak yang rajin." Tidak langsung: ditunjukkan dari dialog/perbuatannya</td></tr>
          <tr><td>📍 <strong>Latar</strong></td><td>Keterangan mengenai tempat, waktu, dan suasana kejadian</td><td>Latar tempat: di perpustakaan. Latar waktu: sore hari. Latar suasana: menegangkan</td></tr>
          <tr><td>📊 <strong>Alur</strong></td><td>Rangkaian kejadian yang membentuk jalannya cerita</td><td>Pengenalan → Konflik → Klimaks → Penyelesaian</td></tr>
          <tr><td>👁️ <strong>Sudut Pandang</strong></td><td>Posisi pencerita dalam menyampaikan cerita</td><td>Orang pertama (aku/saya), orang ketiga (dia/nama tokoh)</td></tr>
          <tr><td>💬 <strong>Amanat</strong></td><td>Pesan moral yang ingin disampaikan pengarang</td><td>"Jangan pernah menyerah", "Persahabatan lebih berharga dari harta"</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>👥 Jenis-Jenis Tokoh</h3>
        <div class="table-wrap"><table>
          <tr><th>Berdasarkan Peran</th><th>Pengertian</th><th>Sifat Umum</th></tr>
          <tr><td><strong>Protagonis</strong></td><td>Tokoh utama/sentral yang menjadi pusat cerita</td><td>Umumnya berwatak baik, menjadi tokoh yang diperjuangkan nasibnya</td></tr>
          <tr><td><strong>Antagonis</strong></td><td>Tokoh penentang protagonis yang menimbulkan konflik</td><td>Umumnya berwatak jahat atau egois</td></tr>
          <tr><td><strong>Tritagonis</strong></td><td>Tokoh pembantu atau penengah antara protagonis dan antagonis</td><td>Netral atau membantu salah satu pihak</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>📊 Jenis-Jenis Alur</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis Alur</th><th>Pengertian</th><th>Ciri</th></tr>
          <tr><td><strong>Alur Maju</strong></td><td>Cerita disusun dari awal hingga akhir secara kronologis</td><td>Peristiwa A → B → C berurutan waktu</td></tr>
          <tr><td><strong>Alur Mundur (Flashback)</strong></td><td>Cerita dimulai dari masa kini lalu menceritakan kejadian masa lalu</td><td>Dimulai dari akhir atau tengah cerita, lalu mundur ke masa lalu</td></tr>
          <tr><td><strong>Alur Campuran</strong></td><td>Gabungan alur maju dan mundur dalam satu cerita</td><td>Ada bagian yang maju dan ada bagian flashback</td></tr>
        </table></div>
        <div class="info-box blue">Tahapan alur: <strong>Orientasi</strong> (pengenalan) → <strong>Konflik</strong> (masalah muncul) → <strong>Klimaks</strong> (puncak masalah) → <strong>Resolusi</strong> (penyelesaian) → <strong>Koda</strong> (penutup/amanat).</div>
      </div>`,
    flashcards: [
      { q:'Sebutkan 7 unsur intrinsik cerita!', a:'Tema, Tokoh, Penokohan, Latar (tempat/waktu/suasana), Alur, Sudut Pandang, dan Amanat.' },
      { q:'Apa perbedaan tokoh dan penokohan?', a:'Tokoh = siapa yang menjadi pelaku dalam cerita. Penokohan = bagaimana cara pengarang menggambarkan sifat dan watak tokoh tersebut.' },
      { q:'Apa itu protagonis, antagonis, dan tritagonis?', a:'Protagonis: tokoh utama (umumnya baik). Antagonis: tokoh penentang yang menimbulkan konflik. Tritagonis: tokoh pembantu/penengah.' },
      { q:'Sebutkan 3 jenis alur cerita!', a:'Alur maju (kronologis awal→akhir), alur mundur/flashback (dari masa kini ke masa lalu), alur campuran (gabungan keduanya).' },
      { q:'Apa itu amanat? Bagaimana cara menemukannya?', a:'Pesan moral yang ingin disampaikan pengarang melalui cerita. Ditemukan setelah membaca seluruh cerita — biasanya tersurat di akhir atau tersirat dari perbuatan tokoh.' },
      { q:'Apa yang dimaksud latar dalam cerita? Sebutkan 3 jenisnya!', a:'Keterangan tentang situasi kejadian cerita. 3 jenis: latar tempat (di mana), latar waktu (kapan), dan latar suasana (bagaimana kondisi/atmosfernya).' },
    ],
  },

  'bindo-4': {
    title: '💡 Ide Pokok',
    sub: 'Menemukan gagasan utama paragraf dan membedakannya dari kalimat penjelas',
    body: `
      <div class="content-section">
        <h3>📌 Apa itu Ide Pokok?</h3>
        <p><strong>Ide pokok</strong> (gagasan utama / pikiran pokok) adalah gagasan inti yang menjadi topik utama suatu paragraf. Seluruh kalimat dalam paragraf membicarakan atau mendukung ide pokok ini.</p>
        <div class="table-wrap"><table>
          <tr><th>Istilah</th><th>Pengertian</th></tr>
          <tr><td><strong>Ide Pokok / Gagasan Utama</strong></td><td>Inti pembicaraan paragraf — biasanya berupa pernyataan umum</td></tr>
          <tr><td><strong>Kalimat Utama</strong></td><td>Kalimat yang mengandung ide pokok — letaknya bisa di awal, akhir, atau tengah</td></tr>
          <tr><td><strong>Kalimat Penjelas</strong></td><td>Kalimat-kalimat yang mendukung, merinci, atau memberi contoh ide pokok</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>📍 Jenis Paragraf Berdasarkan Letak Ide Pokok</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis Paragraf</th><th>Letak Ide Pokok</th><th>Pola</th><th>Contoh Kalimat Utama</th></tr>
          <tr><td><strong>Deduktif</strong></td><td>Di AWAL paragraf</td><td>Umum → Khusus (kalimat utama dulu, lalu diperjelas)</td><td>"Menjaga kebersihan lingkungan sangat penting." (lalu diikuti alasan-alasan)</td></tr>
          <tr><td><strong>Induktif</strong></td><td>Di AKHIR paragraf</td><td>Khusus → Umum (fakta/contoh dulu, lalu kesimpulan)</td><td>Paragraf berisi fakta-fakta, lalu diakhiri: "Oleh karena itu, menjaga kebersihan itu penting."</td></tr>
          <tr><td><strong>Campuran (Deduktif-Induktif)</strong></td><td>Di AWAL dan AKHIR</td><td>Ide pokok diulang di akhir untuk menegaskan</td><td>Kalimat pertama = kalimat utama; kalimat terakhir = penegasan kembali</td></tr>
          <tr><td><strong>Ineratif</strong></td><td>Di TENGAH paragraf</td><td>Penjelas → Utama → Penjelas</td><td>Jarang, biasanya di karya sastra</td></tr>
        </table></div>
        <div class="info-box blue">Paragraf paling umum di soal: <strong>Deduktif</strong> (ide pokok di awal) dan <strong>Induktif</strong> (ide pokok di akhir).</div>
      </div>
      <div class="content-section">
        <h3>🔍 Cara Menemukan Ide Pokok</h3>
        <ol>
          <li><strong>Baca paragraf secara utuh</strong> — jangan hanya sepintas</li>
          <li><strong>Tanya: "Paragraf ini membicarakan apa?"</strong> — jawaban singkatnya = ide pokok</li>
          <li><strong>Cari kalimat paling umum</strong> — yang mencakup semua kalimat lain</li>
          <li><strong>Cek: apakah kalimat lain mendukung/menjelaskannya?</strong> — jika ya, itulah kalimat utama</li>
          <li><strong>Ringkas dalam 1 kalimat singkat</strong> — itulah ide pokoknya</li>
        </ol>
        <div class="info-box green">Ciri kalimat penjelas: berisi contoh, data, fakta spesifik, atau rincian yang mendukung kalimat utama. Sering menggunakan kata "misalnya", "seperti", "contohnya", "selain itu".</div>
      </div>
      <div class="content-section">
        <h3>📝 Contoh Paragraf dan Identifikasi Ide Pokok</h3>
        <div class="info-box">
          <p><em>"<strong>Membaca buku memiliki banyak manfaat bagi pelajar.</strong> Pertama, membaca meningkatkan pengetahuan dan wawasan. Kedua, membaca melatih kemampuan berpikir kritis. Ketiga, membaca memperkaya kosakata. Dengan rajin membaca, prestasi belajar pun ikut meningkat."</em></p>
          <p>✅ <strong>Kalimat utama:</strong> kalimat pertama (bold) — posisi <strong>Deduktif</strong></p>
          <p>✅ <strong>Ide pokok:</strong> manfaat membaca buku bagi pelajar</p>
          <p>✅ <strong>Kalimat penjelas:</strong> kalimat 2, 3, 4, 5 (merinci manfaatnya)</p>
        </div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan ide pokok, kalimat utama, dan kalimat penjelas?', a:'Ide pokok: inti pembicaraan paragraf. Kalimat utama: kalimat yang mengandung ide pokok. Kalimat penjelas: kalimat yang mendukung/merinci kalimat utama.' },
      { q:'Di mana letak ide pokok paragraf deduktif dan induktif?', a:'Deduktif: di AWAL paragraf (umum → khusus). Induktif: di AKHIR paragraf (khusus → umum, diakhiri kesimpulan).' },
      { q:'Sebutkan langkah-langkah menemukan ide pokok!', a:'1. Baca paragraf utuh. 2. Tanya paragraf ini membicarakan apa. 3. Cari kalimat paling umum. 4. Cek apakah kalimat lain mendukungnya. 5. Ringkas menjadi satu kalimat.' },
      { q:'Apa ciri-ciri kalimat penjelas?', a:'Berisi contoh, data, fakta spesifik, atau rincian yang mendukung kalimat utama. Sering dimulai dengan "misalnya", "seperti", "contohnya", "selain itu", "pertama/kedua".' },
      { q:'Paragraf yang ide pokoknya ada di awal DAN akhir disebut apa?', a:'Paragraf campuran (deduktif-induktif) — ide pokok disampaikan di awal, lalu diulang/ditegaskan kembali di akhir paragraf.' },
      { q:'Bagaimana cara membedakan kalimat utama dari kalimat penjelas?', a:'Kalimat utama bersifat umum dan mencakup keseluruhan. Kalimat penjelas bersifat khusus/spesifik dan mendukung kalimat utama. Hapus kalimat itu — jika paragraf masih punya inti, itu kalimat penjelas.' },
    ],
  },

  'bindo-5': {
    title: '🔄 Sinonim & Antonim',
    sub: 'Persamaan kata, lawan kata, dan penggunaannya dalam kalimat',
    body: `
      <div class="content-section">
        <h3>📌 Sinonim (Persamaan Kata)</h3>
        <p><strong>Sinonim</strong> adalah kata-kata yang memiliki makna sama atau hampir sama. Digunakan untuk memperindah tulisan dan menghindari pengulangan kata yang monoton.</p>
        <div class="info-box blue">Sinonim tidak selalu bisa saling menggantikan 100% karena setiap kata memiliki <strong>nuansa makna</strong> yang sedikit berbeda. Contoh: "mati", "meninggal", "wafat", dan "gugur" semua berarti mati, tapi digunakan dalam konteks berbeda.</div>
      </div>
      <div class="content-section">
        <h3>📝 Contoh Sinonim beserta Nuansanya</h3>
        <div class="table-wrap"><table>
          <tr><th>Kata</th><th>Sinonim</th><th>Nuansa Perbedaan</th></tr>
          <tr><td><strong>Mati</strong></td><td>Meninggal, Wafat, Gugur, Mangkat, Tewas</td><td>Meninggal (umum), Wafat (tokoh penting/formal), Gugur (pahlawan), Mangkat (raja), Tewas (kriminal/kecelakaan)</td></tr>
          <tr><td><strong>Besar</strong></td><td>Agung, Raya, Akbar, Luas, Raksasa</td><td>Agung (mulia), Raya (jalan/hari penting), Akbar (nama/acara besar), Luas (area)</td></tr>
          <tr><td><strong>Cantik</strong></td><td>Indah, Elok, Rupawan, Molek, Jelita</td><td>Indah (pemandangan/karya), Rupawan (wajah seseorang), Elok (lebih puitis)</td></tr>
          <tr><td><strong>Pintar</strong></td><td>Cerdas, Pandai, Cakap, Genius, Mahir</td><td>Cerdas (IQ tinggi), Pandai (umum), Cakap (terampil), Mahir (keahlian spesifik)</td></tr>
          <tr><td><strong>Sedih</strong></td><td>Duka, Murung, Pilu, Sendu, Nestapa</td><td>Murung (tampak dari wajah), Pilu (sedih mendalam), Sendu (halus/puitis), Nestapa (sangat menderita)</td></tr>
          <tr><td><strong>Cepat</strong></td><td>Gesit, Lincah, Kilat, Sigap, Tangkas</td><td>Gesit (gerakan tubuh), Kilat (sangat cepat), Sigap (siap bertindak cepat)</td></tr>
          <tr><td><strong>Melihat</strong></td><td>Menatap, Memandang, Mengamati, Memperhatikan</td><td>Menatap (fokus ke satu titik), Mengamati (teliti), Memperhatikan (dengan seksama)</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>↔️ Antonim (Lawan Kata)</h3>
        <p><strong>Antonim</strong> adalah kata yang memiliki makna berlawanan dengan kata lain.</p>
        <div class="table-wrap"><table>
          <tr><th>Kata</th><th>Antonim</th><th>Kata</th><th>Antonim</th></tr>
          <tr><td>Besar</td><td>Kecil</td><td>Cepat</td><td>Lambat</td></tr>
          <tr><td>Panas</td><td>Dingin</td><td>Terang</td><td>Gelap</td></tr>
          <tr><td>Naik</td><td>Turun</td><td>Berani</td><td>Penakut</td></tr>
          <tr><td>Kaya</td><td>Miskin</td><td>Rajin</td><td>Malas</td></tr>
          <tr><td>Senang</td><td>Sedih</td><td>Hadir</td><td>Absen</td></tr>
        </table></div>
        <div class="info-box green">Sinonim dan antonim sering muncul di soal <strong>pilihan kata</strong> — pilih kata yang maknanya paling tepat sesuai konteks kalimat, bukan hanya "sama artinya".</div>
      </div>`,
    flashcards: [
      { q:'Apa itu sinonim? Berikan 3 contoh pasangan sinonim!', a:'Kata yang bermakna sama atau hampir sama. Contoh: besar-agung, pintar-cerdas, sedih-duka.' },
      { q:'Apa perbedaan sinonim dan antonim?', a:'Sinonim: kata yang bermakna sama/mirip (pintar = cerdas). Antonim: kata yang bermakna berlawanan (pintar ≠ bodoh).' },
      { q:'Mengapa "wafat", "meninggal", dan "tewas" tidak selalu bisa saling menggantikan?', a:'Karena setiap sinonim memiliki nuansa berbeda: meninggal (umum), wafat (tokoh penting/formal), tewas (kecelakaan/tindak kriminal). Pilihan tergantung konteks.' },
      { q:'Sinonim dari kata "melihat" yang paling tepat untuk "mengamati dengan teliti"?', a:'"Mengamati" — karena nuansanya mengandung makna melihat dengan seksama dan teliti, berbeda dari sekadar "melihat" atau "menatap".' },
      { q:'Sebutkan antonim dari: besar, panas, naik, rajin, berani!', a:'Besar ↔ kecil. Panas ↔ dingin. Naik ↔ turun. Rajin ↔ malas. Berani ↔ penakut/pengecut.' },
      { q:'Apa fungsi sinonim dalam penulisan?', a:'Memperindah tulisan, menghindari pengulangan kata yang monoton, dan memberikan variasi gaya bahasa agar lebih menarik dibaca.' },
    ],
  },

  'bindo-6': {
    title: '🎨 Ciri & Unsur Poster',
    sub: 'Pengertian, unsur, ciri, dan langkah membuat poster yang efektif',
    body: `
      <div class="content-section">
        <h3>📌 Apa itu Poster?</h3>
        <p><strong>Poster</strong> adalah media komunikasi visual yang berisi pesan, informasi, atau ajakan yang ditampilkan secara singkat, jelas, dan menarik. Poster dirancang untuk menarik perhatian dan mempengaruhi pembaca dalam waktu singkat.</p>
        <div class="table-wrap"><table>
          <tr><th>Jenis Poster</th><th>Tujuan</th><th>Contoh</th></tr>
          <tr><td><strong>Poster Niaga</strong></td><td>Mempromosikan produk/jasa</td><td>Poster iklan minuman, poster promo toko</td></tr>
          <tr><td><strong>Poster Layanan Masyarakat</strong></td><td>Memberikan informasi dan mengajak masyarakat</td><td>Poster "Jaga Kebersihan", poster imunisasi</td></tr>
          <tr><td><strong>Poster Kegiatan</strong></td><td>Mengumumkan acara</td><td>Poster lomba 17 Agustus, poster pentas seni</td></tr>
          <tr><td><strong>Poster Pendidikan</strong></td><td>Menyampaikan informasi edukatif</td><td>Poster cuci tangan, poster hemat energi</td></tr>
          <tr><td><strong>Poster Propaganda</strong></td><td>Mempengaruhi pendapat/sikap</td><td>Poster kampanye, poster anti narkoba</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🧩 Unsur-Unsur Poster</h3>
        <div class="table-wrap"><table>
          <tr><th>Unsur</th><th>Fungsi</th><th>Ketentuan</th></tr>
          <tr><td><strong>Judul / Headline</strong></td><td>Kata kunci utama yang pertama ditangkap mata</td><td>Singkat, ukuran huruf paling besar, mencolok</td></tr>
          <tr><td><strong>Gambar / Ilustrasi</strong></td><td>Memperkuat dan memperjelas pesan</td><td>Relevan dengan isi, menarik, berkualitas baik</td></tr>
          <tr><td><strong>Teks Isi / Body Copy</strong></td><td>Penjelasan singkat isi pesan</td><td>Kalimat pendek, mudah dibaca dari jarak normal</td></tr>
          <tr><td><strong>Slogan</strong></td><td>Kalimat pendek yang mudah diingat dan memperkuat pesan</td><td>"Buang sampah pada tempatnya", "Hidup Sehat Dimulai dari Diri Sendiri"</td></tr>
          <tr><td><strong>Warna</strong></td><td>Menarik perhatian dan menciptakan kesan tertentu</td><td>Kontras antara latar dan tulisan; warna sesuai tema</td></tr>
          <tr><td><strong>Identitas Pembuat</strong></td><td>Menunjukkan sumber/pengirim pesan</td><td>Nama lembaga, logo, kontak jika diperlukan</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>✅ Ciri-Ciri Poster yang Baik</h3>
        <ul>
          <li>📢 Pesan <strong>singkat, padat, dan langsung ke inti</strong> — tidak bertele-tele</li>
          <li>🎨 Gambar/ilustrasi <strong>relevan dan menarik perhatian</strong></li>
          <li>🔤 Huruf <strong>besar dan mudah terbaca</strong> dari jarak jauh</li>
          <li>🌈 Warna <strong>kontras dan menarik</strong> — teks mudah terbaca di atas latar</li>
          <li>🎯 Tujuan <strong>jelas</strong>: mengajak, memberitahu, atau memperingatkan</li>
          <li>📍 Ada <strong>kata kerja ajakan</strong> jika bertujuan menggerakkan: "Ayo!", "Mari", "Jagalah", "Gunakan"</li>
        </ul>
      </div>
      <div class="content-section">
        <h3>✏️ Langkah Membuat Poster</h3>
        <ol>
          <li>Tentukan <strong>tujuan</strong> poster (mengajak, memberitahu, atau mempromosikan)</li>
          <li>Tentukan <strong>sasaran pembaca</strong> (anak-anak, remaja, atau umum)</li>
          <li>Rumuskan <strong>pesan utama</strong> dalam 1-2 kalimat</li>
          <li>Buat <strong>slogan</strong> yang pendek dan mudah diingat</li>
          <li>Pilih <strong>gambar/ilustrasi</strong> yang mendukung pesan</li>
          <li>Susun <strong>tata letak</strong> yang menarik dan seimbang</li>
          <li>Gunakan <strong>warna yang sesuai</strong> dengan pesan dan sasaran</li>
        </ol>
        <div class="info-box green">Poster yang efektif: orang hanya perlu <strong>3-5 detik</strong> untuk menangkap inti pesannya. Jika butuh lebih lama, posternya terlalu rumit.</div>
      </div>`,
    flashcards: [
      { q:'Sebutkan 5 unsur poster dan fungsinya!', a:'Judul/headline (menarik perhatian pertama), gambar/ilustrasi (memperkuat pesan), teks isi (penjelasan singkat), slogan (kalimat mudah diingat), warna (menarik perhatian dan menciptakan kesan).' },
      { q:'Sebutkan 5 jenis poster berdasarkan tujuannya!', a:'Poster niaga (promosi produk), poster layanan masyarakat (info publik), poster kegiatan (umumkan acara), poster pendidikan (edukatif), poster propaganda (mempengaruhi sikap).' },
      { q:'Apa ciri-ciri poster yang baik?', a:'Pesan singkat dan padat, gambar relevan dan menarik, huruf besar dan mudah terbaca, warna kontras, tujuan jelas, serta ada kata ajakan jika tujuannya menggerakkan orang.' },
      { q:'Apa fungsi slogan dalam poster?', a:'Kalimat pendek yang mudah diingat untuk memperkuat pesan poster. Contoh: "Buang sampah pada tempatnya", "Satu tetes bensin, satu jiwa."' },
      { q:'Mengapa warna pada poster harus kontras?', a:'Agar tulisan mudah terbaca di atas latar belakang. Warna yang tidak kontras membuat teks sulit dibaca dan pesan tidak tersampaikan.' },
      { q:'Sebutkan langkah pertama yang harus dilakukan saat membuat poster!', a:'Menentukan tujuan poster — apakah ingin mengajak, memberitahu, memperingatkan, atau mempromosikan. Tujuan menentukan semua elemen poster selanjutnya.' },
    ],
  },

  'bindo-7': {
    title: '🔍 Kata Khusus',
    sub: 'Hiponim, makna sempit, dan penggunaannya dalam tulisan',
    body: `
      <div class="content-section">
        <h3>📌 Kata Khusus (Hiponim)</h3>
        <p><strong>Kata khusus</strong> (hiponim) adalah kata yang memiliki ruang lingkup makna <strong>lebih sempit dan spesifik</strong>, merupakan bagian dari kata yang lebih umum (hipernim).</p>
        <div class="table-wrap"><table>
          <tr><th>Istilah</th><th>Pengertian</th><th>Contoh</th></tr>
          <tr><td><strong>Hiponim</strong> (kata khusus)</td><td>Kata bermakna sempit, bagian dari kelompok yang lebih besar</td><td>Mawar adalah hiponim dari "bunga"</td></tr>
          <tr><td><strong>Hipernim</strong> (kata umum)</td><td>Kata bermakna luas yang mencakup hiponim-hiponinya</td><td>"Bunga" adalah hipernim dari mawar, melati, tulip</td></tr>
          <tr><td><strong>Kohiponim</strong></td><td>Kata-kata yang sama-sama menjadi hiponim dari satu hipernim</td><td>Mawar, melati, tulip = kohiponim (sama-sama hiponim "bunga")</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>📝 Contoh Hipernim dan Hiponim-Hiponimnya</h3>
        <div class="table-wrap"><table>
          <tr><th>Kata Umum (Hipernim)</th><th>Kata Khusus (Hiponim)</th></tr>
          <tr><td>Bunga</td><td>Mawar, Melati, Tulip, Anggrek, Dahlia, Kamboja, Kenanga</td></tr>
          <tr><td>Hewan peliharaan</td><td>Kucing, Anjing, Kelinci, Hamster, Ikan hias, Burung</td></tr>
          <tr><td>Kendaraan</td><td>Mobil, Sepeda motor, Bus, Kereta api, Kapal laut, Pesawat</td></tr>
          <tr><td>Alat memasak</td><td>Panci, Wajan, Spatula, Pisau, Parutan, Cobek</td></tr>
          <tr><td>Buah tropis</td><td>Mangga, Rambutan, Durian, Jambu, Pepaya, Salak</td></tr>
          <tr><td>Profesi</td><td>Dokter, Guru, Petani, Nelayan, Arsitek, Insinyur, Pilot</td></tr>
          <tr><td>Perasaan negatif</td><td>Sedih, Marah, Kecewa, Takut, Malu, Kesal, Cemburu</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🎯 Fungsi Kata Khusus dalam Tulisan</h3>
        <div class="table-wrap"><table>
          <tr><th>Fungsi</th><th>Contoh Penggunaan</th></tr>
          <tr><td><strong>Membuat tulisan lebih spesifik dan jelas</strong></td><td>"Rara menanam <em>mawar merah</em>" lebih spesifik dari "Rara menanam <em>bunga</em>"</td></tr>
          <tr><td><strong>Memperkuat deskripsi</strong></td><td>"Ia mengendarai <em>sepeda motor Honda Beat</em>" lebih deskriptif dari "<em>kendaraan</em>"</td></tr>
          <tr><td><strong>Menghindari ambiguitas</strong></td><td>"Beli <em>nasi goreng</em>" jelas, sedangkan "beli <em>makanan</em>" masih ambigu</td></tr>
        </table></div>
        <div class="info-box green">Semakin spesifik kata yang digunakan, semakin jelas dan hidup tulisannya. Penulis yang baik lebih suka menggunakan kata khusus daripada kata umum.</div>
      </div>
      <div class="content-section">
        <h3>🔁 Hubungan Hipernim–Hiponim dalam Kalimat</h3>
        <div class="info-box">
          <p><strong>Contoh soal:</strong> "Ia menanam berbagai jenis bunga di taman. Ada ___, ___, dan ___ yang tumbuh subur."</p>
          <p>→ Kata yang tepat untuk mengisi titik-titik adalah <strong>kata khusus (hiponim)</strong> dari "bunga": mawar, melati, anggrek, dll.</p>
        </div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan hiponim dan hipernim?', a:'Hiponim (kata khusus): makna sempit, bagian dari kelompok lebih besar (mawar = hiponim bunga). Hipernim (kata umum): makna luas, mencakup banyak hiponim (bunga = hipernim mawar, melati, dll).' },
      { q:'Apa itu kohiponim? Berikan contoh!', a:'Kata-kata yang sama-sama menjadi hiponim dari satu hipernim yang sama. Contoh: mawar, melati, dan tulip adalah kohiponim karena ketiganya sama-sama hiponim dari "bunga".' },
      { q:'Berikan 5 contoh kata khusus dari hipernim "kendaraan"!', a:'Mobil, sepeda motor, bus, kereta api, kapal laut, pesawat terbang, sepeda (semuanya adalah jenis-jenis kendaraan).' },
      { q:'Mengapa kata khusus lebih baik digunakan dalam deskripsi?', a:'Karena lebih spesifik dan jelas. "Ia menanam mawar merah" jauh lebih deskriptif dan hidup dibanding "ia menanam bunga".' },
      { q:'Lengkapi: "Rasa ___, ___, dan ___ adalah contoh kata khusus dari hipernim perasaan negatif."', a:'Contoh: sedih, marah, dan kecewa — ketiganya adalah jenis-jenis perasaan negatif (hiponim dari "perasaan negatif").' },
      { q:'Apa kata khusus yang paling tepat untuk mengisi: "Ayah membeli ___ untuk lauk makan malam" (jenis hipernim: ikan)?', a:'Contoh jawaban: ikan gurami, ikan lele, ikan nila, atau ikan bandeng — semua adalah hiponim (kata khusus) dari "ikan".' },
    ],
  },

  'bindo-8': {
    title: '🌐 Kata Umum',
    sub: 'Hipernim, makna luas, dan penggunaannya dalam penulisan',
    body: `
      <div class="content-section">
        <h3>📌 Kata Umum (Hipernim)</h3>
        <p><strong>Kata umum</strong> (hipernim) adalah kata yang memiliki ruang lingkup makna <strong>luas</strong> dan mencakup banyak kata yang lebih khusus (hiponim). Semakin umum sebuah kata, semakin luas cakupan maknanya.</p>
        <div class="info-box blue">Hubungan: Hipernim (kata umum) mencakup banyak Hiponim (kata khusus). Contoh: "Hewan" → kucing, anjing, singa, gajah, lumba-lumba, dll.</div>
      </div>
      <div class="content-section">
        <h3>📝 Contoh Kata Umum dan Kata-Kata Khususnya</h3>
        <div class="table-wrap"><table>
          <tr><th>Kata Umum (Hipernim)</th><th>Mencakup Kata Khusus (Hiponim)</th></tr>
          <tr><td><strong>Tumbuhan</strong></td><td>Pohon mangga, semak belukar, rumput teki, lumut, tanaman pakis</td></tr>
          <tr><td><strong>Warna</strong></td><td>Merah, biru, hijau, kuning, ungu, oranye, coklat, abu-abu</td></tr>
          <tr><td><strong>Perasaan</strong></td><td>Senang, sedih, marah, takut, kaget, malu, kecewa, bangga</td></tr>
          <tr><td><strong>Alat tulis</strong></td><td>Pensil, pulpen, spidol, penggaris, penghapus, rautan, tip-x</td></tr>
          <tr><td><strong>Makanan</strong></td><td>Nasi goreng, soto, gado-gado, rendang, sate, bakso, mie ayam</td></tr>
          <tr><td><strong>Olahraga</strong></td><td>Sepak bola, basket, renang, badminton, voli, atletik, senam</td></tr>
          <tr><td><strong>Bangunan</strong></td><td>Rumah, sekolah, masjid, pabrik, rumah sakit, jembatan, menara</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🔍 Cara Membedakan Kata Umum dan Kata Khusus</h3>
        <div class="table-wrap"><table>
          <tr><th>Pertanyaan Kunci</th><th>Jika Ya → Kata Umum</th><th>Jika Ya → Kata Khusus</th></tr>
          <tr><td>Apakah kata ini mencakup banyak jenis lain?</td><td>✅ "Buah" mencakup mangga, apel, jeruk...</td><td>❌ "Mangga" hanya satu jenis buah</td></tr>
          <tr><td>Bisakah kata ini dikelompokkan lebih lanjut?</td><td>✅ "Kendaraan" bisa dibagi: darat, air, udara</td><td>❌ "Mobil sedan" sudah sangat spesifik</td></tr>
          <tr><td>Apakah maknanya sudah sangat spesifik?</td><td>❌ "Ikan" masih bisa dibagi banyak jenis</td><td>✅ "Ikan kerapu" sudah spesifik</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🎯 Kapan Menggunakan Kata Umum vs Kata Khusus</h3>
        <div class="table-wrap"><table>
          <tr><th>Situasi</th><th>Gunakan</th><th>Contoh</th></tr>
          <tr><td>Menyebutkan kelompok besar</td><td>Kata Umum</td><td>"Di kebun binatang terdapat berbagai <em>hewan</em> langka."</td></tr>
          <tr><td>Deskripsi yang spesifik dan jelas</td><td>Kata Khusus</td><td>"Harimau Sumatera dan komodo adalah hewan yang dilindungi."</td></tr>
          <tr><td>Soal melengkapi kalimat dengan contoh</td><td>Kata Khusus</td><td>"Di pasar tersedia berbagai buah: ___, ___, dan ___."</td></tr>
        </table></div>
        <div class="info-box green">Tulisan yang baik mengombinasikan kata umum (untuk menyebutkan kelompok) dan kata khusus (untuk memberi contoh/rincian yang jelas).</div>
      </div>`,
    flashcards: [
      { q:'Apa itu kata umum (hipernim)? Berikan 3 contoh!', a:'Kata yang maknanya luas dan mencakup banyak kata yang lebih spesifik. Contoh: buah (mencakup mangga, apel, jeruk), hewan (mencakup kucing, anjing, singa).' },
      { q:'Apa perbedaan kata umum dan kata khusus?', a:'Kata umum (hipernim): makna luas, mencakup banyak kata (buah, hewan, kendaraan). Kata khusus (hiponim): makna sempit dan spesifik (mangga, kucing, mobil).' },
      { q:'Sebutkan 5 kata khusus dari hipernim "perasaan"!', a:'Senang, sedih, marah, takut, kecewa, malu, bangga, cemburu — semuanya adalah jenis-jenis perasaan.' },
      { q:'Kapan sebaiknya menggunakan kata umum dalam tulisan?', a:'Saat menyebutkan kelompok besar atau kategori. Contoh: "Di kebun binatang terdapat berbagai hewan langka" — "hewan" digunakan karena merujuk ke kelompok besar.' },
      { q:'Berikan contoh kalimat yang menggunakan kata umum diikuti kata khusus!', a:'"Di taman itu tumbuh berbagai bunga indah, seperti mawar merah, melati putih, dan anggrek ungu." — "bunga" (umum) lalu diikuti contoh khusus.' },
      { q:'Apa kata umum yang paling tepat untuk kelompok: sepatu olahraga, sandal jepit, sepatu hak tinggi, boots?', a:'"Alas kaki" atau "sepatu" — semua kata tersebut adalah jenis-jenis alas kaki.' },
    ],
  },

  'bindo-9': {
    title: '✨ Makna Kata & Majas',
    sub: 'Makna denotatif, konotatif, ungkapan, dan jenis-jenis majas',
    body: `
      <div class="content-section">
        <h3>📌 Makna Denotatif vs Konotatif</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis Makna</th><th>Pengertian</th><th>Contoh Kata</th><th>Contoh Kalimat</th></tr>
          <tr><td><strong>Denotatif</strong></td><td>Makna sebenarnya/harfiah — makna yang tertera di kamus</td><td>"Bunga" = tanaman berbunga</td><td>"Ibu menanam bunga mawar di taman."</td></tr>
          <tr><td><strong>Konotatif</strong></td><td>Makna tambahan/kiasan — makna yang muncul dari asosiasi budaya atau perasaan</td><td>"Bunga desa" = perempuan cantik</td><td>"Rara adalah bunga desa yang dikagumi semua orang."</td></tr>
        </table></div>
        <div class="table-wrap"><table>
          <tr><th>Kata</th><th>Makna Denotatif</th><th>Makna Konotatif</th></tr>
          <tr><td>Bintang</td><td>Benda langit yang bercahaya</td><td>Orang yang terkenal/berprestasi</td></tr>
          <tr><td>Tangan kanan</td><td>Tangan di sebelah kanan</td><td>Orang kepercayaan/andalan</td></tr>
          <tr><td>Dingin</td><td>Suhu rendah</td><td>Sikap tidak ramah/cuek</td></tr>
          <tr><td>Keras kepala</td><td>Kepala yang keras secara fisik</td><td>Sifat tidak mau mendengar orang lain</td></tr>
          <tr><td>Buah tangan</td><td>Tangan yang sedang memegang buah</td><td>Oleh-oleh/hadiah dari perjalanan</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>💬 Ungkapan (Idiom)</h3>
        <p><strong>Ungkapan</strong> adalah gabungan kata yang maknanya tidak sama dengan arti harfiah kata-kata penyusunnya.</p>
        <div class="table-wrap"><table>
          <tr><th>Ungkapan</th><th>Makna</th><th>Contoh Kalimat</th></tr>
          <tr><td>Panjang tangan</td><td>Suka mencuri</td><td>"Hati-hati dengan orang itu, dia panjang tangan."</td></tr>
          <tr><td>Tinggi hati</td><td>Sombong, angkuh</td><td>"Jangan tinggi hati karena kesuksesan bisa hilang."</td></tr>
          <tr><td>Rendah hati</td><td>Tidak sombong, humble</td><td>"Meski juara, ia tetap rendah hati."</td></tr>
          <tr><td>Besar kepala</td><td>Sombong</td><td>"Sejak menang lomba, ia menjadi besar kepala."</td></tr>
          <tr><td>Ringan tangan</td><td>Suka memukul atau suka menolong</td><td>"Pak guru itu ringan tangan dalam membantu murid."</td></tr>
          <tr><td>Naik daun</td><td>Sedang populer/terkenal</td><td>"Penyanyi itu sedang naik daun."</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🎨 Jenis-Jenis Majas</h3>
        <div class="table-wrap"><table>
          <tr><th>Majas</th><th>Pengertian</th><th>Contoh Kalimat</th></tr>
          <tr><td><strong>Personifikasi</strong></td><td>Benda mati atau abstrak diberi sifat/perilaku manusia</td><td>"Angin membelai rambutku dengan lembut."</td></tr>
          <tr><td><strong>Hiperbola</strong></td><td>Melebih-lebihkan kenyataan untuk penekanan</td><td>"Suaranya membelah langit." / "Sudah seribu kali aku bilang!"</td></tr>
          <tr><td><strong>Simile</strong></td><td>Perbandingan menggunakan kata "seperti", "bagai", "laksana"</td><td>"Wajahnya bagai rembulan di malam hari."</td></tr>
          <tr><td><strong>Metafora</strong></td><td>Perbandingan langsung tanpa kata penghubung</td><td>"Dia adalah singa di lapangan bola."</td></tr>
          <tr><td><strong>Litotes</strong></td><td>Merendahkan diri/sesuatu untuk menunjukkan kesopanan</td><td>"Silakan mampir ke gubuk kami." (padahal rumahnya besar)</td></tr>
          <tr><td><strong>Repetisi</strong></td><td>Pengulangan kata/frasa untuk penekanan</td><td>"Maju terus, maju terus, jangan pernah mundur!"</td></tr>
          <tr><td><strong>Eufemisme</strong></td><td>Penggunaan kata yang lebih halus untuk menggantikan kata yang kasar/tabu</td><td>"Meninggal dunia" → bukan "mati". "Tunanetra" → bukan "buta".</td></tr>
        </table></div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan makna denotatif dan konotatif?', a:'Denotatif: makna sebenarnya/harfiah sesuai kamus. Konotatif: makna tambahan/kiasan yang muncul dari asosiasi budaya. Contoh: "bintang" denotatif = benda langit, konotatif = orang terkenal.' },
      { q:'Apa itu ungkapan (idiom)? Berikan 3 contoh!', a:'Gabungan kata yang maknanya tidak sama dengan arti harfiah. Contoh: panjang tangan (suka mencuri), tinggi hati (sombong), naik daun (sedang populer).' },
      { q:'Sebutkan perbedaan majas simile dan metafora!', a:'Simile: perbandingan menggunakan kata "seperti/bagai/laksana" ("wajahnya bagai rembulan"). Metafora: perbandingan langsung tanpa kata penghubung ("dia adalah singa di lapangan").' },
      { q:'Apa itu majas personifikasi? Berikan contoh!', a:'Majas yang memberi sifat atau perilaku manusia kepada benda mati atau abstrak. Contoh: "Angin membelai rambutku", "Matahari tersenyum pagi ini".' },
      { q:'Apa itu majas hiperbola? Berikan contoh!', a:'Majas yang melebih-lebihkan kenyataan untuk penekanan. Contoh: "Suaranya membelah langit", "Sudah seribu kali aku bilang!"' },
      { q:'Apa itu majas eufemisme? Mengapa digunakan?', a:'Penggunaan kata yang lebih halus untuk menggantikan kata yang kasar atau tabu. Digunakan untuk menjaga kesopanan. Contoh: "meninggal dunia" (bukan "mati"), "tunanetra" (bukan "buta").' },
    ],
  },

  'bindo-10': {
    title: '🔤 Imbuhan',
    sub: 'Jenis imbuhan, fungsi, perubahan huruf, dan contoh pembentukannya',
    body: `
      <div class="content-section">
        <h3>📌 Apa itu Imbuhan (Afiks)?</h3>
        <p><strong>Imbuhan</strong> adalah morfem terikat yang ditambahkan pada kata dasar untuk membentuk kata baru dengan makna berbeda. Ada 4 jenis imbuhan berdasarkan posisinya:</p>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Posisi</th><th>Contoh Imbuhan</th></tr>
          <tr><td><strong>Awalan (Prefiks)</strong></td><td>Di depan kata dasar</td><td>me-, pe-, ber-, ter-, ke-, di-, se-</td></tr>
          <tr><td><strong>Akhiran (Sufiks)</strong></td><td>Di belakang kata dasar</td><td>-an, -kan, -i, -lah, -kah, -nya</td></tr>
          <tr><td><strong>Sisipan (Infiks)</strong></td><td>Di tengah kata dasar</td><td>-el-, -em-, -er-</td></tr>
          <tr><td><strong>Konfiks</strong></td><td>Di depan dan belakang sekaligus</td><td>ke-...-an, per-...-an, me-...-kan</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>⚙️ Imbuhan Paling Penting dan Fungsinya</h3>
        <div class="table-wrap"><table>
          <tr><th>Imbuhan</th><th>Fungsi Utama</th><th>Contoh Pembentukan</th></tr>
          <tr><td><strong>me-</strong></td><td>Membentuk kata kerja aktif (pelaku melakukan sesuatu)</td><td>baca → membaca, tulis → menulis, gambar → menggambar</td></tr>
          <tr><td><strong>di-</strong></td><td>Membentuk kata kerja pasif (sesuatu dilakukan kepada objek)</td><td>baca → dibaca, tulis → ditulis, makan → dimakan</td></tr>
          <tr><td><strong>pe-</strong></td><td>Membentuk kata benda pelaku (orang yang melakukan)</td><td>lari → pelari, tulis → penulis, nyanyi → penyanyi</td></tr>
          <tr><td><strong>ber-</strong></td><td>Memiliki/menggunakan/melakukan</td><td>sepeda → bersepeda, baju → berbaju, teman → berteman</td></tr>
          <tr><td><strong>ter-</strong></td><td>Paling/tidak sengaja/sudah</td><td>baik → terbaik, jatuh → terjatuh, buka → terbuka</td></tr>
          <tr><td><strong>-an</strong></td><td>Membentuk kata benda hasil/tempat/alat</td><td>baca → bacaan, minum → minuman, tidur → tidur-tiduran</td></tr>
          <tr><td><strong>-kan</strong></td><td>Melakukan sesuatu untuk orang lain / menjadikan</td><td>baca → bacakan, bawa → bawakan, besar → besarkan</td></tr>
          <tr><td><strong>-i</strong></td><td>Melakukan berulang / pada sesuatu</td><td>tandatangan → menandatangani, warnai → mewarnai</td></tr>
          <tr><td><strong>-lah</strong></td><td>Memperhalus kalimat perintah</td><td>baca → bacalah, diam → diamlah, makan → makanlah</td></tr>
          <tr><td><strong>ke-...-an</strong></td><td>Terlalu/keadaan/mengalami</td><td>besar → kebesaran, panas → kepanasan, hujan → kehujanan</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🔄 Perubahan Huruf Saat Bertemu Awalan me-</h3>
        <p>Huruf awal kata dasar tertentu <strong>luluh (hilang)</strong> saat bertemu awalan <strong>me-</strong>:</p>
        <div class="table-wrap"><table>
          <tr><th>Huruf Awal</th><th>Perubahan</th><th>Contoh</th></tr>
          <tr><td><strong>k</strong></td><td>k luluh → meng-</td><td>kirim → mengirim, ketik → mengetik, kopi → mengopi</td></tr>
          <tr><td><strong>p</strong></td><td>p luluh → mem-</td><td>pukul → memukul, potong → memotong, percaya → mempercayai</td></tr>
          <tr><td><strong>t</strong></td><td>t luluh → men-</td><td>tulis → menulis, tanam → menanam, tari → menari</td></tr>
          <tr><td><strong>s</strong></td><td>s luluh → meny-</td><td>sapu → menyapu, simpan → menyimpan, siram → menyiram</td></tr>
          <tr><td>Huruf lain (b,d,g,h,l,m,n,r,w,y,vokal)</td><td>Tidak luluh, hanya ditambah me-</td><td>baca → membaca, gambar → menggambar, ambil → mengambil</td></tr>
        </table></div>
        <div class="info-box green">Hafalan luluh: <strong>K P T S</strong> — "KaPTan-nya Selalu luluh saat bertemu me-"</div>
      </div>
      <div class="content-section">
        <h3>📝 Contoh Kalimat dengan Imbuhan</h3>
        <div class="table-wrap"><table>
          <tr><th>Kata Dasar</th><th>+me-</th><th>+di-</th><th>+pe-</th><th>+-an</th></tr>
          <tr><td>baca</td><td>membaca</td><td>dibaca</td><td>pembaca</td><td>bacaan</td></tr>
          <tr><td>tulis</td><td>menulis</td><td>ditulis</td><td>penulis</td><td>tulisan</td></tr>
          <tr><td>nyanyi</td><td>menyanyi</td><td>dinyanyikan</td><td>penyanyi</td><td>nyanyian</td></tr>
          <tr><td>ajar</td><td>mengajar</td><td>diajar</td><td>pengajar</td><td>ajaran</td></tr>
        </table></div>
      </div>`,
    flashcards: [
      { q:'Sebutkan 4 jenis imbuhan berdasarkan posisinya!', a:'Awalan/prefiks (di depan: me-, ber-), akhiran/sufiks (di belakang: -an, -kan), sisipan/infiks (di tengah: -el-, -er-), konfiks (depan+belakang: ke-...-an).' },
      { q:'Huruf apa saja yang luluh saat bertemu awalan me-? Berikan contoh!', a:'K, P, T, S luluh. Contoh: kirim→mengirim (k luluh), pukul→memukul (p luluh), tulis→menulis (t luluh), sapu→menyapu (s luluh).' },
      { q:'Apa perbedaan fungsi me- dan di-?', a:'Me-: kata kerja AKTIF, pelaku melakukan sesuatu (Budi membaca buku). Di-: kata kerja PASIF, objek dikenai tindakan (Buku dibaca Budi).' },
      { q:'Apa fungsi imbuhan ke-...-an? Berikan 3 contoh!', a:'Menyatakan terlalu/mengalami keadaan. Contoh: kepanasan (terlalu panas), kehujanan (kena hujan), kebesaran (terlalu besar).' },
      { q:'Apa fungsi imbuhan pe- dan -an? Berikan contoh masing-masing!', a:'Pe-: pelaku pekerjaan (tulis→penulis, nyanyi→penyanyi). -an: hasil/benda (baca→bacaan, minum→minuman).' },
      { q:'Kata "mempercayai" terdiri dari imbuhan apa saja?', a:'me- + per-...-i + percaya. Awalan me- (aktif) + per- + kata dasar "caya" + akhiran -i (pada/kepada sesuatu).' },
    ],
  },

  'bindo-11': {
    title: '📝 Literasi & Teks',
    sub: 'Memahami teks: gagasan utama, amanat, nilai, makna tersurat dan tersirat',
    body: `
      <div class="content-section">
        <h3>📌 Literasi Membaca — Kemampuan Memahami Teks</h3>
        <p><strong>Literasi</strong> adalah kemampuan memahami, menganalisis, dan menggunakan informasi dari teks tulisan. Ada dua level pemahaman teks:</p>
        <div class="table-wrap"><table>
          <tr><th>Level</th><th>Pengertian</th><th>Cara Menemukan</th><th>Contoh</th></tr>
          <tr><td><strong>Tersurat</strong></td><td>Informasi yang dinyatakan langsung dan jelas dalam teks</td><td>Cukup membaca teksnya</td><td>"Budi pergi ke sekolah pukul 07.00." → Fakta tersurat: Budi berangkat pagi.</td></tr>
          <tr><td><strong>Tersirat</strong></td><td>Informasi/makna yang tidak dinyatakan langsung, harus disimpulkan</td><td>Berpikir kritis, hubungkan konteks</td><td>"Wajah Ibu berubah merah ketika mendengar kabar itu." → Tersirat: Ibu marah atau malu.</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🎭 Unsur-Unsur yang Dikaji dalam Literasi Teks</h3>
        <div class="table-wrap"><table>
          <tr><th>Unsur</th><th>Pengertian</th><th>Cara Menemukannya</th></tr>
          <tr><td><strong>Gagasan Utama</strong></td><td>Inti pembicaraan paragraf/teks</td><td>Cari kalimat paling umum yang mencakup semua isi</td></tr>
          <tr><td><strong>Amanat</strong></td><td>Pesan moral yang ingin disampaikan pengarang</td><td>Baca keseluruhan, perhatikan perilaku tokoh dan akhir cerita</td></tr>
          <tr><td><strong>Nilai</strong></td><td>Ajaran atau prinsip hidup yang terkandung dalam teks</td><td>Identifikasi nilai moral, sosial, budaya, atau agama</td></tr>
          <tr><td><strong>Fakta</strong></td><td>Pernyataan yang dapat dibuktikan kebenarannya</td><td>Cari angka, data, peristiwa yang bisa dicek</td></tr>
          <tr><td><strong>Opini</strong></td><td>Pendapat atau pandangan seseorang yang belum tentu benar</td><td>Cari kata "menurut", "saya rasa", "sebaiknya", "seharusnya"</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>💡 Fakta vs Opini</h3>
        <div class="table-wrap"><table>
          <tr><th>Fakta</th><th>Opini</th></tr>
          <tr><td>Dapat dibuktikan dengan data/bukti</td><td>Berdasarkan pendapat/perasaan, belum tentu benar</td></tr>
          <tr><td>"Indonesia merdeka pada 17 Agustus 1945."</td><td>"Menurut saya, hari kemerdekaan harus dirayakan lebih meriah."</td></tr>
          <tr><td>"Suhu rata-rata bumi meningkat 1°C dalam 100 tahun terakhir."</td><td>"Pemanasan global adalah ancaman terbesar bagi umat manusia."</td></tr>
          <tr><td>Kata kunci: angka, tanggal, nama, tempat spesifik</td><td>Kata kunci: menurut, saya rasa, sebaiknya, seharusnya, tampaknya</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>📊 Nilai-Nilai dalam Teks</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis Nilai</th><th>Pengertian</th><th>Contoh dalam Cerita</th></tr>
          <tr><td><strong>Nilai Moral</strong></td><td>Ajaran tentang baik/buruk perilaku manusia</td><td>Kejujuran selalu menguntungkan, berbohong merugikan diri sendiri</td></tr>
          <tr><td><strong>Nilai Sosial</strong></td><td>Ajaran tentang hubungan antar manusia dalam masyarakat</td><td>Tolong-menolong, gotong-royong, menghargai orang lain</td></tr>
          <tr><td><strong>Nilai Budaya</strong></td><td>Ajaran yang berkaitan dengan adat dan tradisi</td><td>Menghormati orang tua, menjaga tradisi daerah</td></tr>
          <tr><td><strong>Nilai Agama</strong></td><td>Ajaran yang bersumber dari kepercayaan agama</td><td>Berdoa sebelum bekerja, bersyukur atas nikmat Tuhan</td></tr>
        </table></div>
        <div class="info-box green">Cara menemukan amanat: tanyakan "Pelajaran apa yang bisa kita ambil dari cerita ini?" — jawabannya itulah amanat.</div>
      </div>`,
    flashcards: [
      { q:'Apa perbedaan makna tersurat dan tersirat?', a:'Tersurat: informasi yang langsung dinyatakan dalam teks (tinggal baca). Tersirat: informasi yang tidak dinyatakan langsung, harus disimpulkan dengan berpikir kritis.' },
      { q:'Apa perbedaan fakta dan opini? Berikan contoh masing-masing!', a:'Fakta: dapat dibuktikan ("Indonesia merdeka 17 Agustus 1945"). Opini: pendapat yang belum tentu benar ("Menurut saya, hari kemerdekaan harus dirayakan lebih meriah").' },
      { q:'Kata kunci apa yang biasanya menandai kalimat opini?', a:'"Menurut saya/para ahli", "saya rasa", "sebaiknya", "seharusnya", "tampaknya", "mungkin" — menunjukkan ini pendapat, bukan fakta.' },
      { q:'Sebutkan 4 jenis nilai yang bisa ditemukan dalam teks!', a:'Nilai moral (baik/buruk perilaku), nilai sosial (hubungan antar manusia), nilai budaya (adat dan tradisi), nilai agama (ajaran kepercayaan).' },
      { q:'Bagaimana cara menemukan amanat dalam sebuah cerita?', a:'Tanyakan: "Pelajaran apa yang bisa diambil dari cerita ini?" Perhatikan perilaku tokoh, konflik yang terjadi, dan bagaimana cerita diselesaikan.' },
      { q:'Apa yang dimaksud literasi membaca?', a:'Kemampuan untuk memahami, menganalisis, dan menggunakan informasi dari teks tulisan — bukan sekadar bisa membaca, tapi bisa memahami makna tersurat dan tersirat.' },
    ],
  },

  'bindo-12': {
    title: '📚 Jenis Teks',
    sub: 'Teks fiksi, non-fiksi, puisi, pantun, fabel, dan struktur teks',
    body: `
      <div class="content-section">
        <h3>📌 Fiksi vs Non-Fiksi</h3>
        <div class="table-wrap"><table>
          <tr><th>Aspek</th><th>Teks Fiksi</th><th>Teks Non-Fiksi</th></tr>
          <tr><td>Sumber</td><td>Imajinasi/rekaan pengarang</td><td>Fakta dan kenyataan</td></tr>
          <tr><td>Tujuan</td><td>Menghibur, menyampaikan pesan moral</td><td>Menginformasikan, menjelaskan, meyakinkan</td></tr>
          <tr><td>Kebenaran</td><td>Tidak harus benar secara faktual</td><td>Harus akurat dan dapat dibuktikan</td></tr>
          <tr><td>Contoh</td><td>Cerpen, novel, puisi, fabel, dongeng, pantun</td><td>Laporan, biografi, artikel, teks eksplanasi</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🎭 Jenis Teks Fiksi</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Ciri Khas</th><th>Contoh</th></tr>
          <tr><td><strong>Cerpen</strong></td><td>Cerita pendek, satu konflik utama, sedikit tokoh</td><td>Cerita tentang persahabatan di sekolah</td></tr>
          <tr><td><strong>Fabel</strong></td><td>Tokohnya hewan yang berperilaku seperti manusia + ada amanat</td><td>"Si Kancil dan Buaya", "Semut dan Belalang"</td></tr>
          <tr><td><strong>Dongeng</strong></td><td>Cerita khayalan tentang keajaiban, tokoh supranatural</td><td>Cinderella, Malin Kundang, Bawang Merah Bawang Putih</td></tr>
          <tr><td><strong>Legenda</strong></td><td>Cerita rakyat tentang asal-usul suatu tempat atau benda</td><td>Legenda Danau Toba, Tangkuban Perahu</td></tr>
          <tr><td><strong>Puisi</strong></td><td>Bahasa indah, berirama, bermakna padat</td><td>Puisi "Ibu" karya Chairil Anwar</td></tr>
          <tr><td><strong>Drama</strong></td><td>Ditulis dalam bentuk dialog, untuk dipentaskan</td><td>Naskah drama sekolah</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>📋 Jenis Teks Non-Fiksi</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Tujuan</th><th>Struktur Umum</th><th>Contoh</th></tr>
          <tr><td><strong>Eksplanasi</strong></td><td>Menjelaskan proses/fenomena alam atau sosial</td><td>Pernyataan umum → Deretan penjelas → Interpretasi</td><td>"Bagaimana hujan terbentuk", "Proses terjadinya gempa"</td></tr>
          <tr><td><strong>Persuasif</strong></td><td>Membujuk pembaca agar setuju/melakukan sesuatu</td><td>Pendapat → Argumen → Penegasan ulang</td><td>Iklan, kampanye, editorial "Mari hemat air!"</td></tr>
          <tr><td><strong>Narasi</strong></td><td>Menceritakan peristiwa secara kronologis</td><td>Orientasi → Komplikasi → Resolusi</td><td>Autobiografi, laporan perjalanan</td></tr>
          <tr><td><strong>Deskripsi</strong></td><td>Menggambarkan objek secara detail agar pembaca seolah melihat</td><td>Identifikasi → Deskripsi bagian</td><td>Deskripsi pemandangan, deskripsi tokoh</td></tr>
          <tr><td><strong>Eksposisi</strong></td><td>Memaparkan informasi/gagasan secara objektif</td><td>Tesis → Argumen → Penegasan</td><td>Artikel majalah, esai ilmiah populer</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>🎵 Pantun — Struktur dan Ciri</h3>
        <div class="table-wrap"><table>
          <tr><th>Unsur Pantun</th><th>Keterangan</th><th>Contoh</th></tr>
          <tr><td><strong>Jumlah baris</strong></td><td>4 baris dalam 1 bait</td><td>—</td></tr>
          <tr><td><strong>Sampiran</strong></td><td>Baris 1 dan 2 — tidak berkaitan langsung dengan isi, hanya sebagai pembuka berirama</td><td>"Pergi ke pasar membeli ikan, / Ikannya segar terlihat indah,"</td></tr>
          <tr><td><strong>Isi</strong></td><td>Baris 3 dan 4 — berisi pesan/makna sebenarnya</td><td>"Kalau ingin menjadi bintang, / Rajin belajar dari muda."</td></tr>
          <tr><td><strong>Sajak/rima</strong></td><td>Pola a-b-a-b (baris 1 rima dengan 3, baris 2 rima dengan 4)</td><td>ikan-bintang (a), indah-muda (b)</td></tr>
        </table></div>
        <div class="info-box green">Jenis pantun: pantun anak (lucu), pantun muda-mudi (cinta), pantun nasihat (bijaksana), pantun teka-teki, pantun agama.</div>
      </div>`,
    flashcards: [
      { q:'Sebutkan perbedaan teks fiksi dan non-fiksi!', a:'Fiksi: rekaan pengarang, tidak harus faktual, tujuan menghibur (cerpen, fabel, puisi). Non-fiksi: berdasarkan fakta, harus akurat, tujuan menginformasikan (laporan, artikel, eksplanasi).' },
      { q:'Apa perbedaan fabel, dongeng, dan legenda?', a:'Fabel: tokoh hewan berperilaku manusia + ada amanat. Dongeng: cerita khayalan dengan keajaiban/supranatural. Legenda: cerita rakyat tentang asal-usul tempat atau benda.' },
      { q:'Sebutkan ciri-ciri pantun!', a:'4 baris per bait, baris 1-2 sampiran (pembuka), baris 3-4 isi (pesan), bersajak a-b-a-b (baris 1 rima dengan 3, baris 2 rima dengan 4).' },
      { q:'Apa tujuan teks eksplanasi? Apa strukturnya?', a:'Menjelaskan proses/fenomena alam atau sosial. Struktur: pernyataan umum → deretan penjelas (proses) → interpretasi/kesimpulan.' },
      { q:'Apa perbedaan teks persuasif dan eksposisi?', a:'Persuasif: bertujuan membujuk/memengaruhi pembaca agar melakukan atau percaya sesuatu. Eksposisi: memaparkan informasi secara objektif tanpa memaksa pembaca setuju.' },
      { q:'Perhatikan pantun: "Pagi hari minum kopi / Kopinya panas dan harum / Jika ingin jadi juara / Rajinlah belajar setiap waktu" — mana sampiran dan isinya?', a:'Sampiran: baris 1-2 ("Pagi hari minum kopi / Kopinya panas dan harum"). Isi: baris 3-4 ("Jika ingin jadi juara / Rajinlah belajar setiap waktu").' },
    ],
  },

  'bindo-13': {
    title: '📬 Surat & Teks Praktis',
    sub: 'Surat resmi, tidak resmi, bagian-bagian surat, pengumuman, iklan, dan laporan',
    body: `
      <div class="content-section">
        <h3>📌 Surat Resmi vs Surat Tidak Resmi</h3>
        <div class="table-wrap"><table>
          <tr><th>Aspek</th><th>Surat Resmi</th><th>Surat Tidak Resmi</th></tr>
          <tr><td>Bahasa</td><td>Baku, formal, sesuai EYD</td><td>Santai, sehari-hari, boleh tidak baku</td></tr>
          <tr><td>Kop surat</td><td>Ada (identitas lembaga)</td><td>Tidak ada</td></tr>
          <tr><td>Nomor surat</td><td>Ada (untuk pengarsipan)</td><td>Tidak ada</td></tr>
          <tr><td>Salam pembuka</td><td>"Dengan hormat,"</td><td>"Hai", "Halo", "Assalamualaikum"</td></tr>
          <tr><td>Salam penutup</td><td>"Hormat kami," / "Hormat saya,"</td><td>"Salam rindu," / "Dari sahabatmu,"</td></tr>
          <tr><td>Tujuan</td><td>Keperluan formal/organisasi/resmi</td><td>Keperluan pribadi/keluarga/teman</td></tr>
          <tr><td>Contoh</td><td>Surat izin sekolah, surat undangan resmi, surat lamaran</td><td>Surat untuk sahabat, surat liburan untuk keluarga</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>📋 Bagian-Bagian Surat Resmi dan Fungsinya</h3>
        <div class="table-wrap"><table>
          <tr><th>No.</th><th>Bagian</th><th>Fungsi</th><th>Contoh Isi</th></tr>
          <tr><td>1</td><td><strong>Kop Surat</strong></td><td>Identitas lembaga pengirim (nama, alamat, logo, kontak)</td><td>SDN 1 Wonosari, Jl. Veteran No.5, Wonosari 55813</td></tr>
          <tr><td>2</td><td><strong>Nomor Surat</strong></td><td>Kode unik untuk pengarsipan dan pelacakan surat</td><td>No. 012/SDN1/X/2025</td></tr>
          <tr><td>3</td><td><strong>Tanggal Surat</strong></td><td>Tanggal surat dibuat</td><td>Wonosari, 15 Oktober 2025</td></tr>
          <tr><td>4</td><td><strong>Lampiran</strong></td><td>Keterangan dokumen tambahan yang disertakan</td><td>Lampiran: 1 lembar fotokopi KTP</td></tr>
          <tr><td>5</td><td><strong>Perihal / Hal</strong></td><td>Ringkasan inti/topik surat dalam satu baris</td><td>Hal: Izin Tidak Masuk Sekolah</td></tr>
          <tr><td>6</td><td><strong>Alamat Tujuan</strong></td><td>Kepada siapa surat ditujukan</td><td>Yth. Kepala SDN 1 Wonosari</td></tr>
          <tr><td>7</td><td><strong>Salam Pembuka</strong></td><td>Kalimat pembuka yang sopan dan formal</td><td>Dengan hormat,</td></tr>
          <tr><td>8</td><td><strong>Isi Surat</strong></td><td>Pesan utama: pendahuluan, isi pokok, dan penutup</td><td>Paragraf berisi tujuan penulisan surat</td></tr>
          <tr><td>9</td><td><strong>Salam Penutup</strong></td><td>Kalimat penutup yang sopan</td><td>Hormat kami, / Hormat saya,</td></tr>
          <tr><td>10</td><td><strong>Tanda Tangan</strong></td><td>Tanda tangan + nama terang + jabatan pembuat surat</td><td>ttd. Slamet Santoso (Orang Tua Siswa)</td></tr>
        </table></div>
        <div class="info-box blue">Urutan bagian surat resmi tidak boleh ditukar-tukar — ini adalah struktur baku yang wajib diikuti agar surat dianggap sah dan formal.</div>
      </div>
      <div class="content-section">
        <h3>✉️ Contoh Surat Izin Tidak Masuk Sekolah</h3>
        <div class="info-box">
          <p><strong>SDN 1 WONOSARI</strong><br>
          Jl. Veteran No. 5, Wonosari, Gunungkidul 55813<br>
          ─────────────────────────────────────<br>
          Nomor : 001/SDN1/III/2025<br>
          Hal &nbsp;&nbsp;&nbsp;: Izin Tidak Masuk Sekolah<br><br>
          Yth. Bapak/Ibu Wali Kelas VI A<br>
          SDN 1 Wonosari<br><br>
          Dengan hormat,<br>
          Saya yang bertanda tangan di bawah ini adalah orang tua dari:<br>
          Nama &nbsp;: Budi Santoso &nbsp;&nbsp; Kelas: VI A<br><br>
          Memberitahukan bahwa anak saya tidak dapat hadir pada hari Senin, 10 Maret 2025, karena sakit demam. Kami mohon izin dan bimbingan Bapak/Ibu guru.<br><br>
          Demikian surat ini saya buat. Atas perhatian Bapak/Ibu, saya ucapkan terima kasih.<br><br>
          Hormat saya,<br><br>
          Slamet Santoso</p>
        </div>
      </div>
      <div class="content-section">
        <h3>📢 Pengumuman dan Iklan</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis</th><th>Tujuan</th><th>Ciri Khas</th><th>Unsur Wajib</th></tr>
          <tr><td><strong>Pengumuman</strong></td><td>Menyampaikan informasi kepada khalayak umum</td><td>Bahasa jelas dan lugas, berisi informasi faktual</td><td>5W+1H: What, Who, When, Where, Why, How</td></tr>
          <tr><td><strong>Iklan</strong></td><td>Mempromosikan produk/jasa/kegiatan</td><td>Menarik, persuasif, ada slogan, visual mencolok</td><td>Nama produk, keunggulan, harga (jika ada), kontak</td></tr>
        </table></div>
      </div>
      <div class="content-section">
        <h3>📊 Jenis-Jenis Laporan</h3>
        <div class="table-wrap"><table>
          <tr><th>Jenis Laporan</th><th>Isi</th><th>Struktur Umum</th></tr>
          <tr><td><strong>Laporan Kegiatan</strong></td><td>Mendokumentasikan suatu acara/program yang telah dilaksanakan</td><td>Pendahuluan → Pelaksanaan → Hasil → Penutup</td></tr>
          <tr><td><strong>Laporan Perjalanan</strong></td><td>Menceritakan kunjungan ke suatu tempat beserta temuan-temuannya</td><td>Tujuan → Perjalanan → Temuan/Pengamatan → Kesimpulan</td></tr>
          <tr><td><strong>Laporan Percobaan</strong></td><td>Mendokumentasikan eksperimen sains</td><td>Tujuan → Alat &amp; Bahan → Langkah → Hasil → Kesimpulan</td></tr>
          <tr><td><strong>Laporan Pengamatan</strong></td><td>Mendokumentasikan observasi tanpa mengubah kondisi</td><td>Tujuan → Cara Pengamatan → Hasil → Kesimpulan</td></tr>
        </table></div>
        <div class="info-box green">Perbedaan laporan percobaan dan pengamatan: Percobaan = ada eksperimen aktif (mengubah kondisi). Pengamatan = hanya mengamati tanpa mengubah kondisi objek.</div>
      </div>`,
    flashcards: [
      { q:'Sebutkan 5 perbedaan surat resmi dan tidak resmi!', a:'1. Bahasa: baku vs santai. 2. Kop surat: ada vs tidak. 3. Nomor surat: ada vs tidak. 4. Salam: "Dengan hormat" vs "Hai/Halo". 5. Tujuan: formal vs pribadi.' },
      { q:'Sebutkan 10 bagian surat resmi secara urut!', a:'1. Kop surat. 2. Nomor. 3. Tanggal. 4. Lampiran. 5. Perihal. 6. Alamat tujuan. 7. Salam pembuka. 8. Isi surat. 9. Salam penutup. 10. Tanda tangan.' },
      { q:'Apa fungsi "perihal/hal" dalam surat resmi?', a:'Menuliskan inti/topik surat dalam satu baris singkat agar pembaca langsung tahu tujuan surat tanpa harus membaca seluruh isi terlebih dahulu.' },
      { q:'Apa itu 5W+1H dalam pengumuman?', a:'What (apa kegiatannya), Who (siapa yang terlibat), When (kapan), Where (di mana), Why (mengapa), How (bagaimana caranya) — unsur informasi lengkap sebuah pengumuman.' },
      { q:'Apa perbedaan laporan percobaan dan laporan pengamatan?', a:'Percobaan: ada eksperimen aktif yang mengubah kondisi (memanaskan air, mencampurkan zat). Pengamatan: hanya mengamati tanpa mengubah kondisi objek yang diamati.' },
      { q:'Apa yang dimaksud kop surat dan apa isinya?', a:'Bagian paling atas surat resmi yang berisi identitas lengkap lembaga pengirim: nama lembaga, alamat lengkap, nomor telepon, email, dan logo/lambang lembaga.' },
    ],
  },
