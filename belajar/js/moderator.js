...
// Fetch kolom ringan — skip quiz_details & tka_history yang berisi data jawaban besar
const LIGHT_COLS = 'user_id,xp,streak,last_date,read,quiz_scores,quiz_attempts,activity';
...
async function loadAllData() {
  ...
  _allProgress = {};
  (progRes.data || []).forEach(row => { _allProgress[row.user_id] = row; });
}
