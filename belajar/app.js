  ...
  if (radarCtx) {
    _chartRadar = new Chart(radarCtx, {
      ...
      options: {
        ...
        scales: { r: { min: 0, max: 100, ticks: { stepSize: 25, font: { family: 'Nunito', size: 10, weight: '700' }, color: '#94A3B8', backdropColor: 'transparent', callback: v => v + '%' }, pointLabels: { font: { family: 'Nunito', size: 12, weight: '800' }, color: '#1E293B' }, grid: { color: 'rgba(226,232,240,0.8)' }, angleLines: { color: 'rgba(226,232,240,0.6)' } } },
      },
    });
  }
